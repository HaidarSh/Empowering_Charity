...
import { d1 as MARKETPLACE_CONTRACT_ROLES, a1 as ContractWrapper, v as AbiSchema, d2 as MarketplaceContractSchema, a2 as ContractEncoder, aR as AddressZero, d3 as ListingNotFoundError, B as BigNumber, aP as getRoleHash, o as buildTransactionFunction, y as invariant, b7 as isNativeToken, bB as NATIVE_TOKENS, T as Transaction, d4 as WrongListingTypeError, X as resolveAddress, aM as normalizePriceValue, b9 as fetchCurrencyMetadata, aF as formatUnits, b2 as MaxUint256, d5 as AuctionAlreadyStartedError, bA as AuctionHasNotEndedError, bf as fetchCurrencyValue, d6 as isAddress, c as __vitePreload, ai as Contract } from "./index-R4o_uq0C.js";
import { D as DEFAULT_QUERY_ALL_COUNT, f as fetchTokenMetadataForContract, I as InterfaceId_IERC721, c as InterfaceId_IERC1155 } from "./QueryParams-32a56510.browser.esm-BJnH1Vvy.js";
import { m as mapOffer, v as validateNewListingParam, h as handleTokenApproval, a as isWinningBid, i as isTokenApprovedForTransfer } from "./marketplace-e3129e2f.browser.esm-DnhYzV1W.js";
...
class MarketplaceAuction {
  constructor(contractWrapper, storage) {
     ...
     * ```
     */
    __publicField(this, "buyoutListing", /* @__PURE__ */ buildTransactionFunction(async (listingId) => {
     ...
     * ```
     */
    __publicField(this, "makeBid", /* @__PURE__ */ buildTransactionFunction(async (listingId, pricePerToken) => {
      const listing = await this.validateListing(BigNumber.from(listingId));
      ...
      if (winningBid) {
        ...
        invariant(tokenPrice.gte(reservePrice));
      }
     ...
     */
    __publicField(this, "closeListing", /* @__PURE__ */ buildTransactionFunction(async (listingId, closeFor) => {
      if (!closeFor) {
     ...
     * @param listingId - the auction  listing ud to close
     */
    __publicField(this, "executeSale", /* @__PURE__ */ buildTransactionFunction(async (listingId) => {
      const listing = await this.validateListing(BigNumber.from(listingId));
      try {
        const winningBid = await this.getWinningBid(listingId);
     ...
     */
    __publicField(this, "updateListing", /* @__PURE__ */ buildTransactionFunction(async (listing) => {
      const tx = Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
...
class MarketplaceDirect {
  constructor(contractWrapper, storage) {
     ...
     * ```
     */
    __publicField(this, "makeOffer", /* @__PURE__ */ buildTransactionFunction(async (listingId, quantityDesired, currencyContractAddress, pricePerToken, expirationDate) => {
     ...
     * ```
     */
    __publicField(this, "acceptOffer", /* @__PURE__ */ buildTransactionFunction(async (listingId, addressOfOfferor) => {
      await this.validateListing(BigNumber.from(listingId));
     ...
     */
    __publicField(this, "buyoutListing", /* @__PURE__ */ buildTransactionFunction(async (listingId, quantityDesired, receiver) => {
      const listing = await this.validateListing(BigNumber.from(listingId));
      const {
        valid,
        error
...
const _Marketplace = class _Marketplace {
  constructor(network, address, storage) {
    ...
    __publicField(this, "buyoutListing", /* @__PURE__ */ buildTransactionFunction(async (listingId, quantityDesired, receiver) => {
      ...
      switch (listing.listingType) {
        case ListingType.Direct: {
          invariant(quantityDesired !== void 0);
     ...
     * ```
     */
    __publicField(this, "makeOffer", /* @__PURE__ */ buildTransactionFunction(async (listingId, pricePerToken, quantity) => {
      const listing = await this.contractWrapper.read("listings", [listingId]);
      if (listing.listingId.toString() !== listingId.toString()) {
        throw new ListingNotFoundError(this.getAddress(), listingId.toString());
      }
     ...
     */
    __publicField(this, "setBidBufferBps", /* @__PURE__ */ buildTransactionFunction(async (bufferBps) => {
     ...
     */
    __publicField(this, "setTimeBufferInSeconds", /* @__PURE__ */ buildTransactionFunction(async (bufferInSeconds) => {
      await this.roles.verify(["admin"], await this.contractWrapper.getSignerAddress());
     ...
     */
    __publicField(this, "allowListingFromSpecificAssetOnly", /* @__PURE__ */ buildTransactionFunction(async (contractAddress) => {
      const encoded = [];
     ...
     */
    __publicField(this, "allowListingFromAnyAsset", /* @__PURE__ */ buildTransactionFunction(async () => {
      const encoded = [];
      const members = await this.roles.get("asset");
...
__publicField(_Marketplace, "contractRoles", MARKETPLACE_CONTRACT_ROLES);
let Marketplace = _Marketplace;
export {
  Marketplace
};
