...
import { aa as FEATURE_TOKEN, b9 as fetchCurrencyMetadata, X as resolveAddress, o as buildTransactionFunction, T as Transaction, a2 as ContractEncoder, ba as FEATURE_TOKEN_MINTABLE, bb as FEATURE_TOKEN_BATCH_MINTABLE, bc as FEATURE_TOKEN_BURNABLE, bd as FEATURE_TOKEN_CLAIM_CONDITIONS_V2, be as FEATURE_TOKEN_SIGNATURE_MINTABLE, bf as fetchCurrencyValue, B as BigNumber, bg as parseUnits, $ as AmountSchema, y as invariant, aM as normalizePriceValue, a3 as CustomContractSchema } from "./index-R4o_uq0C.js";
import { a as assertEnabled } from "./assertEnabled-d1700f0b.browser.esm-DFK6vCrZ.js";
import { d as detectContractFeature, a as ContractMetadata } from "./contract-appuri-5c40af52.browser.esm-FEDBCqrq.js";
...
import { j as Signature20PayloadInput, k as Signature20PayloadOutput, m as MintRequest20 } from "./index-MMLm2ukI.js";
...
class Erc20Burnable {
  constructor(erc20, contractWrapper) {
     ...
     * ```
     */
    __publicField(this, "tokens", /* @__PURE__ */ buildTransactionFunction(async (amount) => {
     ...
     * ```
     */
    __publicField(this, "from", /* @__PURE__ */ buildTransactionFunction(async (holder, amount) => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "burnFrom",
...
class Erc20ClaimableWithConditions {
  ...
  constructor(erc20, contractWrapper, storage) {
     ...
     */
    __publicField(this, "to", /* @__PURE__ */ buildTransactionFunction(async (destinationAddress, amount, options) => {
...
class Erc20BatchMintable {
  constructor(erc20, contractWrapper) {
     ...
     * ```
     */
    __publicField(this, "to", /* @__PURE__ */ buildTransactionFunction(async (args) => {
...
class Erc20Mintable {
  ...
  constructor(erc20, contractWrapper) {
     ...
     * ```
     */
    __publicField(this, "to", /* @__PURE__ */ buildTransactionFunction(async (to, amount) => {
...
class Erc20 {
  constructor(contractWrapper, storage, chainId) {
     ...
     * @twfeature ERC20
     */
    __publicField(this, "transfer", /* @__PURE__ */ buildTransactionFunction(async (to, amount) => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "transfer",
     ...
     * @twfeature ERC20
     */
    __publicField(this, "transferFrom", /* @__PURE__ */ buildTransactionFunction(async (from, to, amount) => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "transferFrom",
     ...
     * @twfeature ERC20
     */
    __publicField(this, "setAllowance", /* @__PURE__ */ buildTransactionFunction(async (spender, amount) => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "approve",
     ...
     * ```
     */
    __publicField(this, "transferBatch", /* @__PURE__ */ buildTransactionFunction(async (args) => {
      const contractEncoder = new ContractEncoder(this.contractWrapper);
     ...
     * @twfeature ERC20Mintable
     */
    __publicField(this, "mintTo", /* @__PURE__ */ buildTransactionFunction(async (receiver, amount) => {
     ...
     */
    __publicField(this, "burn", /* @__PURE__ */ buildTransactionFunction(async (amount) => {
     ...
     */
    __publicField(this, "claim", /* @__PURE__ */ buildTransactionFunction(async (amount, options) => {
     ...
     * @twfeature ERC20ClaimPhasesV2 | ERC20ClaimPhasesV1 | ERC20ClaimConditionsV2 | ERC20ClaimConditionsV1
     */
    __publicField(this, "claimTo", /* @__PURE__ */ buildTransactionFunction(async (destinationAddress, amount, options) => {
      var _a;
