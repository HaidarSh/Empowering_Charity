const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index.es-CVIUbrM9.js","assets/index-R4o_uq0C.js","assets/index-CMa6kN8T.css"])))=>i.map(i=>d[i]);
import { W as WagmiConnector, _ as _defineProperty, w as walletIds, a as getAddress, b as Web3Provider, U as UserRejectedRequestError, S as SwitchChainError, h as hexValue, e as getValidPublicRPCUrl, c as __vitePreload } from "./index-R4o_uq0C.js";
const chainsToRequest = /* @__PURE__ */ new Set([1, 137, 10, 42161, 56]);
...
class WalletConnectConnector extends WagmiConnector {
  ...
  async initProvider() {
    const {
      ...
      const {
        default: EthereumProvider2,
        OPTIONAL_EVENTS: OPTIONAL_EVENTS2,
        OPTIONAL_METHODS: OPTIONAL_METHODS2
      } = await import("./index.es-CVIUbrM9.js");
      return {
        default: EthereumProvider2,
        OPTIONAL_EVENTS: OPTIONAL_EVENTS2,
        OPTIONAL_METHODS: OPTIONAL_METHODS2
