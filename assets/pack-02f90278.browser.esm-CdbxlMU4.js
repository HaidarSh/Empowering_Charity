...
import { Z as z, bC as BigNumberishSchema, $ as AmountSchema, a0 as AddressOrEnsSchema, db as PACK_CONTRACT_ROLES, dc as FEATURE_PACK_VRF, a1 as ContractWrapper, v as AbiSchema, dd as PackContractSchema, a2 as ContractEncoder, aP as getRoleHash, aR as AddressZero, B as BigNumber, b9 as fetchCurrencyMetadata, aF as formatUnits, o as buildTransactionFunction, T as Transaction, X as resolveAddress, aM as normalizePriceValue, de as IPackVRFAbi, c as __vitePreload, df as LINK_TOKEN_ADDRESS } from "./index-R4o_uq0C.js";
import { h as hasERC20Allowance } from "./hasERC20Allowance-654a940b.browser.esm-BYJcbl4m.js";
import { R as RawDateSchema, a as assertEnabled } from "./assertEnabled-d1700f0b.browser.esm-DFK6vCrZ.js";
import { a as ContractMetadata, b as ContractAppURI, G as GasCostEstimator, C as ContractEvents, d as detectContractFeature } from "./contract-appuri-5c40af52.browser.esm-FEDBCqrq.js";
...
import "./erc-1155-7ce9bee1.browser.esm-y4q00_Zu.js";
...
class PackVRF {
  constructor(network, address, storage, options, chainId) {
     ...
     * @twfeature PackVRF
     */
    __publicField(this, "open", /* @__PURE__ */ buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this = this;
     ...
     * @twfeature PackVRF
     */
    __publicField(this, "claimRewards", /* @__PURE__ */ buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this2 = this;
    ...
    let contractWrapper = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : new ContractWrapper(network, address, IPackVRFAbi, options, storage);
...
const _Pack = class _Pack extends StandardErc1155 {
  constructor(network, address, storage) {
     ...
     * ```
     */
    __publicField(this, "create", /* @__PURE__ */ buildTransactionFunction(async (metadataWithRewards) => {
     ...
     * ```
     */
    __publicField(this, "addPackContents", /* @__PURE__ */ buildTransactionFunction(async (packId, packContents) => {
     ...
     * ```
     */
    __publicField(this, "createTo", /* @__PURE__ */ buildTransactionFunction(async (to, metadataWithRewards) => {
