...
var u = ((i) => (i.MAGIC_HANDLE_RESPONSE = "MAGIC_HANDLE_RESPONSE", i.MAGIC_OVERLAY_READY = "MAGIC_OVERLAY_READY", i.MAGIC_SHOW_OVERLAY = "MAGIC_SHOW_OVERLAY", i.MAGIC_HIDE_OVERLAY = "MAGIC_HIDE_OVERLAY", i.MAGIC_HANDLE_EVENT = "MAGIC_HANDLE_EVENT", i))(u || {}), o = ((_2) => (_2.MAGIC_HANDLE_REQUEST = "MAGIC_HANDLE_REQUEST", _2))(o || {});
var c = ((_2) => (_2.Harmony = "HARMONY", _2))(c || {});
var define_process_env_default = {};
var vt = Object.create;
var Y$1 = Object.defineProperty, It = Object.defineProperties, Pt = Object.getOwnPropertyDescriptor, xt = Object.getOwnPropertyDescriptors, bt$1 = Object.getOwnPropertyNames, Oe = Object.getOwnPropertySymbols, $t = Object.getPrototypeOf, _e = Object.prototype.hasOwnProperty, Nt = Object.prototype.propertyIsEnumerable;
var Ce = (n, e, t) => e in n ? Y$1(n, e, { enumerable: true, configurable: true, writable: true, value: t }) : n[e] = t, Z = (n, e) => {
  for (var t in e || (e = {})) _e.call(e, t) && Ce(n, t, e[t]);
  if (Oe) for (var t of Oe(e)) Nt.call(e, t) && Ce(n, t, e[t]);
  return n;
}, De = (n, e) => It(n, xt(e));
var Mt = (n, e) => () => (e || n((e = { exports: {} }).exports, e), e.exports), wt = (n, e) => {
  for (var t in e) Y$1(n, t, { get: e[t], enumerable: true });
}, At = (n, e, t, r2) => {
  if (e && typeof e == "object" || typeof e == "function") for (let o2 of bt$1(e)) !_e.call(n, o2) && o2 !== t && Y$1(n, o2, { get: () => e[o2], enumerable: !(r2 = Pt(e, o2)) || r2.enumerable });
  return n;
};
var Lt = (n, e, t) => (t = n != null ? vt($t(n)) : {}, At(!n || !n.__esModule ? Y$1(t, "default", { value: n, enumerable: true }) : t, n));
...
var lt = Mt((Tr, be) => {
  ...
  R.prototype.eventNames = function() {
    ...
    for (r2 in t = this._events) Nn.call(t, r2) && e.push(v ? r2.slice(1) : r2);
  ...
  R.prototype.listeners = function(e) {
    ...
    for (var o2 = 0, s = r2.length, a2 = new Array(s); o2 < s; o2++) a2[o2] = r2[o2].fn;
    return a2;
  };
  ...
  R.prototype.emit = function(e, t, r2, o2, s, a2) {
    var i = v ? v + e : e;
    if (!this._events[i]) return false;
    ...
    if (c2.fn) {
      ...
      for (u2 = 1, l = new Array(p2 - 1); u2 < p2; u2++) l[u2 - 1] = arguments[u2];
      c2.fn.apply(c2.context, l);
    } else {
      var P = c2.length, A;
      for (u2 = 0; u2 < P; u2++) switch (c2[u2].once && this.removeListener(e, c2[u2].fn, void 0, true), p2) {
        case 1:
        ...
        case 4:
          ...
          break;
        default:
          if (!l) for (A = 1, l = new Array(p2 - 1); A < p2; A++) l[A - 1] = arguments[A];
  ...
  R.prototype.removeListener = function(e, t, r2, o2) {
    ...
    if (!t) return ie2(this, s), this;
    var a2 = this._events[s];
    if (a2.fn) a2.fn === t && (!o2 || a2.once) && (!r2 || a2.context === r2) && ie2(this, s);
    else {
      for (var i = 0, c2 = [], p2 = a2.length; i < p2; i++) (a2[i].fn !== t || o2 && !a2[i].once || r2 && a2[i].context !== r2) && c2.push(a2[i]);
...
var Pe = { SEMVER_SPEC_VERSION: "2.0.0", MAX_LENGTH: 256, MAX_SAFE_INTEGER: Ot, MAX_SAFE_COMPONENT_LENGTH: 16 }, Ct = typeof process == "object" && define_process_env_default && define_process_env_default.NODE_DEBUG && /\bsemver\b/i.test(define_process_env_default.NODE_DEBUG) ? (...n) => console.error("SEMVER", ...n) : () => {
}, m = Ct, W = St(function(n, e) {
  let { MAX_SAFE_COMPONENT_LENGTH: t } = Pe, r2 = (e = n.exports = {}).re = [], o2 = e.src = [], s = e.t = {}, a2 = 0, i = (c2, p2, l) => {
    let u2 = a2++;
    m(u2, p2), s[c2] = u2, o2[u2] = p2, r2[u2] = new RegExp(p2, l ? "g" : void 0);
  };
  ...
  let t = ke$1.test(n), r2 = ke$1.test(e);
  return t && r2 && (n = +n, e = +e), n === e ? 0 : t && !r2 ? -1 : r2 && !t ? 1 : n < e ? -1 : 1;
}, _t = (n, e) => Xe(e, n), Dt = { compareIdentifiers: Xe, rcompareIdentifiers: _t }, { MAX_LENGTH: qe, MAX_SAFE_INTEGER: Q } = Pe, { re: Je$1, t: Ue } = W, { compareIdentifiers: K$1 } = Dt, E$1 = class E {
  constructor(e, t) {
    if (t && typeof t == "object" || (t = { loose: !!t, includePrerelease: false }), e instanceof E$1) {
    ...
    let r2 = e.trim().match(t.loose ? Je$1[Ue.LOOSE] : Je$1[Ue.FULL]);
    if (!r2) throw new TypeError(`Invalid Version: ${e}`);
    if (this.raw = e, this.major = +r2[1], this.minor = +r2[2], this.patch = +r2[3], this.major > Q || this.major < 0) throw new TypeError("Invalid major version");
  ...
  compare(e) {
    if (m("SemVer.compare", this.version, this.options, e), !(e instanceof E$1)) {
      if (typeof e == "string" && e === this.version) return 0;
      e = new E$1(e, this.options);
    }
    return e.version === this.version ? 0 : this.compareMain(e) || this.comparePre(e);
  }
  compareMain(e) {
    return e instanceof E$1 || (e = new E$1(e, this.options)), K$1(this.major, e.major) || K$1(this.minor, e.minor) || K$1(this.patch, e.patch);
  }
  comparePre(e) {
    if (e instanceof E$1 || (e = new E$1(e, this.options)), this.prerelease.length && !e.prerelease.length) return -1;
    if (!this.prerelease.length && e.prerelease.length) return 1;
    if (!this.prerelease.length && !e.prerelease.length) return 0;
    let t = 0;
    do {
      let r2 = this.prerelease[t], o2 = e.prerelease[t];
      if (m("prerelease compare", t, r2, o2), r2 === void 0 && o2 === void 0) return 0;
      if (o2 === void 0) return 1;
      if (r2 === void 0) return -1;
      if (r2 !== o2) return K$1(r2, o2);
    } while (++t);
  }
  compareBuild(e) {
    e instanceof E$1 || (e = new E$1(e, this.options));
    let t = 0;
    do {
    ...
    switch (e) {
      ...
      case "pre":
        if (this.prerelease.length === 0) this.prerelease = [0];
          ...
          for (; --r2 >= 0; ) typeof this.prerelease[r2] == "number" && (this.prerelease[r2]++, r2 = -2);
...
}, kt = (n, e, t) => new E$1(n, t).compare(new E$1(e, t)), k$1 = kt, qt = (n, e, t) => k$1(n, e, t) === 0, Jt = qt, Ut = (n, e, t) => k$1(n, e, t) !== 0, Gt = Ut, Ft = (n, e, t) => k$1(n, e, t) > 0, Kt = Ft, jt = (n, e, t) => k$1(n, e, t) >= 0, Wt = jt, Xt = (n, e, t) => k$1(n, e, t) < 0, Bt = Xt, Ht = (n, e, t) => k$1(n, e, t) <= 0, Vt = Ht, zt = (n, e, t, r2) => {
  switch (e) {
    case "===":
...
}, Ie = zt, j$1 = Symbol("SemVer ANY"), L = class {
  static get ANY() {
    return j$1;
  }
  constructor(e, t) {
    ...
    m("comparator", e, t), this.options = t, this.loose = !!t.loose, this.parse(e), this.semver === j$1 ? this.value = "" : this.value = this.operator + this.semver.version, m("comp", this);
  }
  parse(e) {
    let t = this.options.loose ? Ge[Fe.COMPARATORLOOSE] : Ge[Fe.COMPARATOR], r2 = e.match(t);
    if (!r2) throw new TypeError(`Invalid comparator: ${e}`);
    this.operator = r2[1] !== void 0 ? r2[1] : "", this.operator === "=" && (this.operator = ""), r2[2] ? this.semver = new E$1(r2[2], this.options.loose) : this.semver = j$1;
  }
  toString() {
    return this.value;
  }
  test(e) {
    if (m("Comparator.test", e, this.options.loose), this.semver === j$1 || e === j$1) return true;
  ...
  intersects(e, t) {
    ...
    if (t && typeof t == "object" || (t = { loose: !!t, includePrerelease: false }), this.operator === "") return this.value === "" || new $$1(e.value, t).test(this.value);
    if (e.operator === "") return e.value === "" || new $$1(this.value, t).test(e.semver);
...
}, { re: Ge, t: Fe } = W, $$1 = class $ {
  constructor(e, t) {
    if (t && typeof t == "object" || (t = { loose: !!t, includePrerelease: false }), e instanceof $$1) return e.loose === !!t.loose && e.includePrerelease === !!t.includePrerelease ? e : new $$1(e.raw, t);
    if (e instanceof L) return this.raw = e.value, this.set = [[e]], this.format(), this;
    if (this.options = t, this.loose = !!t.loose, this.includePrerelease = !!t.includePrerelease, this.raw = e, this.set = e.split(/\s*\|\|\s*/).map((r2) => this.parseRange(r2.trim())).filter((r2) => r2.length), !this.set.length) throw new TypeError(`Invalid SemVer Range: ${e}`);
    this.format();
  }
  format() {
  ...
  parseRange(e) {
    ...
    e = e.replace(r2, pn(this.options.includePrerelease)), m("hyphen replace", e), e = e.replace(g[y.COMPARATORTRIM], Yt), m("comparator trim", e, g[y.COMPARATORTRIM]), e = (e = (e = e.replace(g[y.TILDETRIM], Zt)).replace(g[y.CARETTRIM], Qt)).split(/\s+/).join(" ");
  ...
  intersects(e, t) {
    if (!(e instanceof $$1)) throw new TypeError("a Range is required");
  ...
  test(e) {
    ...
    for (let t = 0; t < this.set.length; t++) if (un(this.set[t], e, this.options)) return true;
    return false;
  }
}, { re: g, t: y, comparatorTrimReplace: Yt, tildeTrimReplace: Zt, caretTrimReplace: Qt } = W, Ke = (n, e) => {
  let t = true, r2 = n.slice(), o2 = r2.pop();
  for (; t && r2.length; ) t = r2.every((s) => o2.intersects(s, e)), o2 = r2.pop();
  return t;
}, en = (n, e) => (m("comp", n, e), n = rn(n, e), m("caret", n), n = tn(n, e), m("tildes", n), n = on(n, e), m("xrange", n), n = cn(n, e), m("stars", n), n), T$1 = (n) => !n || n.toLowerCase() === "x" || n === "*", tn = (n, e) => n.trim().split(/\s+/).map((t) => nn(t, e)).join(" "), nn = (n, e) => {
  let t = e.loose ? g[y.TILDELOOSE] : g[y.TILDE];
  return n.replace(t, (r2, o2, s, a2, i) => {
    let c2;
    return m("tilde", n, r2, o2, s, a2, i), T$1(o2) ? c2 = "" : T$1(s) ? c2 = `>=${o2}.0.0 <${+o2 + 1}.0.0-0` : T$1(a2) ? c2 = `>=${o2}.${s}.0 <${o2}.${+s + 1}.0-0` : i ? (m("replaceTilde pr", i), c2 = `>=${o2}.${s}.${a2}-${i} <${o2}.${+s + 1}.0-0`) : c2 = `>=${o2}.${s}.${a2} <${o2}.${+s + 1}.0-0`, m("tilde return", c2), c2;
  });
  ...
  return n.replace(t, (o2, s, a2, i, c2) => {
    let p2;
    return m("caret", n, o2, s, a2, i, c2), T$1(s) ? p2 = "" : T$1(a2) ? p2 = `>=${s}.0.0${r2} <${+s + 1}.0.0-0` : T$1(i) ? p2 = s === "0" ? `>=${s}.${a2}.0${r2} <${s}.${+a2 + 1}.0-0` : `>=${s}.${a2}.0${r2} <${+s + 1}.0.0-0` : c2 ? (m("replaceCaret pr", c2), p2 = s === "0" ? a2 === "0" ? `>=${s}.${a2}.${i}-${c2} <${s}.${a2}.${+i + 1}-0` : `>=${s}.${a2}.${i}-${c2} <${s}.${+a2 + 1}.0-0` : `>=${s}.${a2}.${i}-${c2} <${+s + 1}.0.0-0`) : (m("no pr"), p2 = s === "0" ? a2 === "0" ? `>=${s}.${a2}.${i}${r2} <${s}.${a2}.${+i + 1}-0` : `>=${s}.${a2}.${i}${r2} <${s}.${+a2 + 1}.0-0` : `>=${s}.${a2}.${i} <${+s + 1}.0.0-0`), m("caret return", p2), p2;
  });
  ...
  return n.replace(t, (r2, o2, s, a2, i, c2) => {
    m("xRange", n, r2, o2, s, a2, i, c2);
    let p2 = T$1(s), l = p2 || T$1(a2), u2 = l || T$1(i), P = u2;
    return o2 === "=" && P && (o2 = ""), c2 = e.includePrerelease ? "-0" : "", p2 ? r2 = o2 === ">" || o2 === "<" ? "<0.0.0-0" : "*" : o2 && P ? (l && (a2 = 0), i = 0, o2 === ">" ? (o2 = ">=", l ? (s = +s + 1, a2 = 0, i = 0) : (a2 = +a2 + 1, i = 0)) : o2 === "<=" && (o2 = "<", l ? s = +s + 1 : a2 = +a2 + 1), o2 === "<" && (c2 = "-0"), r2 = `${o2 + s}.${a2}.${i}${c2}`) : l ? r2 = `>=${s}.0.0${c2} <${+s + 1}.0.0-0` : u2 && (r2 = `>=${s}.${a2}.0${c2} <${s}.${+a2 + 1}.0-0`), m("xRange return", r2), r2;
  });
}, cn = (n, e) => (m("replaceStars", n, e), n.trim().replace(g[y.STAR], "")), ln = (n, e) => (m("replaceGTE0", n, e), n.trim().replace(g[e.includePrerelease ? y.GTE0PRE : y.GTE0], "")), pn = (n) => (e, t, r2, o2, s, a2, i, c2, p2, l, u2, P, A) => `${t = T$1(r2) ? "" : T$1(o2) ? `>=${r2}.0.0${n ? "-0" : ""}` : T$1(s) ? `>=${r2}.${o2}.0${n ? "-0" : ""}` : a2 ? `>=${t}` : `>=${t}${n ? "-0" : ""}`} ${c2 = T$1(p2) ? "" : T$1(l) ? `<${+p2 + 1}.0.0-0` : T$1(u2) ? `<${p2}.${+l + 1}.0-0` : P ? `<=${p2}.${l}.${u2}-${P}` : n ? `<${p2}.${l}.${+u2 + 1}-0` : `<=${c2}`}`.trim(), un = (n, e, t) => {
  for (let r2 = 0; r2 < n.length; r2++) if (!n[r2].test(e)) return false;
  if (e.prerelease.length && !t.includePrerelease) {
    for (let r2 = 0; r2 < n.length; r2++) if (m(n[r2].semver), n[r2].semver !== L.ANY && n[r2].semver.prerelease.length > 0) {
      let o2 = n[r2].semver;
      if (o2.major === e.major && o2.minor === e.minor && o2.patch === e.patch) return true;
    }
    return false;
  }
  return true;
...
var { MAX_LENGTH: dn } = Pe, { re: je, t: We } = W, mn = (n, e) => {
  if (e && typeof e == "object" || (e = { loose: !!e, includePrerelease: false }), n instanceof E$1) return n;
...
}, hn = mn, { re: ee, t: te$1 } = W, He = (n, e) => {
  if (n instanceof E$1) return n;
  if (typeof n == "number" && (n = String(n)), typeof n != "string") return null;
  let t = null;
  if ((e = e || {}).rtl) {
    let r2;
    for (; (r2 = ee[te$1.COERCERTL].exec(n)) && (!t || t.index + t[0].length !== n.length); ) t && r2.index + r2[0].length === t.index + t[0].length || (t = r2), ee[te$1.COERCERTL].lastIndex = r2.index + r2[1].length + r2[2].length;
    ee[te$1.COERCERTL].lastIndex = -1;
  } else t = n.match(ee[te$1.COERCE]);
...
function ze(n) {
  return re(n) ? false : !N$1(n.jsonrpc) && !N$1(n.id) && (!N$1(n.result) || !N$1(n.error));
}
function Ye(n) {
  return re(n) ? false : typeof n == "number" && Object.values(m$1).includes(n);
}
function se$2(n) {
  if (!n) return true;
  for (let e in n) if (Object.hasOwnProperty.call(n, e)) return false;
  return true;
}
var h = {};
function In(n, e) {
...
var Ze$1 = { "magic-sdk": "magic-sdk", "@magic-sdk/react-native": "magic-sdk-rn", "@magic-sdk/react-native-bare": "magic-sdk-rn-bare", "@magic-sdk/react-native-expo": "magic-sdk-rn-expo" };
var b = class extends Error {
  ...
  constructor(t) {
    ...
    this.rawMessage = (t == null ? void 0 : t.message) || "Internal error", this.code = Ye(r2) ? r2 : m$1.InternalError, this.message = `Magic RPC Error: [${this.code}] ${this.rawMessage}`, this.data = (t == null ? void 0 : t.data) || void 0, Object.setPrototypeOf(this, M$1.prototype);
  }
}, q$1 = class q {
  constructor(e, t) {
    this.code = e;
  ...
  constructor(t, r2, o2, s) {
    ...
    this.data = s;
    this.__proto__ = Error;
    Object.setPrototypeOf(this, J$1.prototype);
  }
}, X = class {
  constructor(e, t, r2) {
    this.code = t;
...
function mr() {
  return new q$1(a.DuplicateIframe, "Duplicate iframes found.");
}
function st() {
  return new q$1(a.SyncWeb3Method, "Non-async web3 methods are deprecated in web3 > 1.0 and are not supported by the Magic web3 provider. Please use an async method instead.");
}
function ot() {
  return new q$1(a.ReactNativeEndpointConfiguration, `CUSTOM DOMAINS ARE NOT SUPPORTED WHEN USING MAGIC SDK WITH REACT NATIVE! The \`endpoint\` parameter SHOULD NOT be provided. The Magic \`<iframe>\` is automatically wrapped by a WebView pointed at \`${h.defaultEndpoint}\`. Changing this default behavior will lead to unexpected results and potentially security-threatening bugs.`);
}
function* xn() {
  let n = 0;
...
function _(n) {
  var e, t, r2;
  return $n(n) || (n.jsonrpc = (e = n.jsonrpc) != null ? e : "2.0", n.id = xe(), n.method = (t = n.method) != null ? t : "noop", n.params = (r2 = n.params) != null ? r2 : [], at$1(n)), n;
}
function d(n, e = []) {
  return at$1({ params: e, method: n, jsonrpc: "2.0", id: xe() });
}
var S = class {
  constructor(e) {
...
var pt = Lt(lt()), $e$1 = class $e extends pt.default {
};
function ae$1() {
  let n = new $e$1();
  return { emitter: n, createChainingEmitterMethod: (r2, o2) => (...s) => (n[r2].apply(n, s), o2), createBoundEmitterMethod: (r2) => (...o2) => n[r2].apply(n, o2) };
}
var ut$1 = Symbol("isPromiEvent");
function dt(n) {
  return !!n[ut$1];
}
function ce$1(n) {
  let e = Ne(n), { createBoundEmitterMethod: t, createChainingEmitterMethod: r2 } = ae$1(), o2 = Symbol("Promise.then"), s = Symbol("Promise.catch"), a2 = Symbol("Promise.finally"), i = (l, u2) => (...P) => {
    let A = u2[l].apply(u2, P);
    return c2(A);
  }, c2 = (l) => Object.assign(l, { [ut$1]: true, [o2]: l[o2] || l.then, [s]: l[s] || l.catch, [a2]: l[a2] || l.finally, then: i(o2, l), catch: i(s, l), finally: i(a2, l), on: r2("on", l), once: r2("once", l), addListener: r2("addListener", l), off: r2("off", l), removeListener: r2("removeListener", l), removeAllListeners: r2("removeAllListeners", l), emit: t("emit"), eventNames: t("eventNames"), listeners: t("listeners"), listenerCount: t("listenerCount") }), p2 = c2(e.then((l) => (p2.emit("done", l), p2.emit("settled"), l), (l) => {
...
var I = class {
  ...
  request(e) {
    let t = this.overlay.post(o.MAGIC_HANDLE_REQUEST, _(e)), r2 = ce$1((s, a2) => {
      t.then((i) => {
        if (o$1(), i.hasError) a2(new M$1(i.payload.error));
        else if (i.hasResult) s(i.payload.result);
        else throw et$1();
      }).catch((i) => {
        o$1(), a2(i);
      });
    }), o$1 = this.overlay.on(u.MAGIC_HANDLE_EVENT, (s) => {
      var i;
...
var H$1 = {};
wt(H$1, { clear: () => Sn, getItem: () => D$1, iterate: () => Dn, key: () => Cn, keys: () => _n, length: () => On, removeItem: () => ue$1, setItem: () => G });
var pe$2;
function C$1(n) {
  return (...e) => x(this, null, function* () {
    return pe$2 || (pe$2 = yield h.configureStorage()), yield pe$2.ready(), pe$2[n](...e);
  });
}
var D$1 = C$1("getItem"), G = C$1("setItem"), ue$1 = C$1("removeItem"), Sn = C$1("clear"), On = C$1("length"), Cn = C$1("key"), _n = C$1("keys"), Dn = C$1("iterate");
function mt() {
...
var Me = "STORE_KEY_PRIVATE_KEY", de$1 = "STORE_KEY_PUBLIC_JWK", we = "ECDSA", Et = "P-256", kn = { name: we, namedCurve: Et }, qn = { name: we, namedCurve: Et };
function me() {
  ue$1(de$1), ue$1(Me);
}
function ft$1() {
  return x(this, null, function* () {
    ...
    let { subtle: e } = window.crypto, t = yield D$1(Me);
    if (!t || !e) {
...
function Jn() {
  return x(this, null, function* () {
    ...
    return (yield D$1(de$1)) || (yield Un()), D$1(de$1);
  });
}
function Un() {
  return x(this, null, function* () {
...
var { createBoundEmitterMethod: fe$1, createChainingEmitterMethod: F } = ae$1(), ye = class extends I {
  constructor() {
    super(...arguments);
    this.isMagic = true;
    this.on = F("on", this);
    ...
    this.emit = fe$1("emit");
    this.eventNames = fe$1("eventNames");
    this.listeners = fe$1("listeners");
    this.listenerCount = fe$1("listenerCount");
  }
  sendAsync(t, r2) {
    if (!r2) throw rt$1({ procedure: "Magic.rpcProvider.sendAsync", argument: 1, expected: "function", received: r2 === null ? "null" : typeof r2 });
    if (Array.isArray(t)) this.overlay.post(o.MAGIC_HANDLE_REQUEST, t.map((o2) => {
      let s = _(o2);
      return this.prefixPayloadMethodForTestMode(s), s;
    })).then((o2) => {
      r2(null, o2.map((s) => De(Z({}, s.payload), { error: s.hasError ? new M$1(s.payload.error) : null })));
    });
    else {
      let o$1 = _(t);
      this.prefixPayloadMethodForTestMode(o$1), this.overlay.post(o.MAGIC_HANDLE_REQUEST, o$1).then((s) => {
        r2(s.hasError ? new M$1(s.payload.error) : null, s.payload);
      });
    }
  }
  send(t, r2) {
...
var ge$1 = class ge extends I {
  constructor() {
    super(void 0);
    this.__sdk_access_field_descriptors__ = /* @__PURE__ */ new Map();
    this.__is_initialized__ = false;
    this.utils = { createPromiEvent: ce$1, isPromiEvent: dt, encodeJSON: ne$1, decodeJSON: Ve, createJsonRpcRequestPayload: d, standardizeJsonRpcRequestPayload: _, storage: H$1 };
    let t = [this, ...Wn(this)];
    Rt.forEach((r2) => {
  ...
  createError(t, r2, o2) {
    return new J$1(this, t, r2, o2);
  }
}, Le = class extends ge$1 {
}, w = class extends ge$1 {
};
...
function Bn(n) {
  ...
  if (Array.isArray(e) ? e.forEach((s) => {
    Tt(s) ? (s.init(this), (s.name || s.name !== w.Anonymous) && (this[s.name] = s), s instanceof w.Internal && (se$2(s.config) || (t[s.name] = s.config))) : r2.push(s);
  }) : Object.keys(e).forEach((s) => {
    if (Tt(e[s])) {
      e[s].init(this);
      let a2 = e[s];
      this[s] = a2, a2 instanceof w.Internal && (se$2(a2.config) || (t[e[s].name] = a2.config));
    } else r2.push(e[s]);
  }), r2.length) throw nt(r2);
  return t;
}
var z$1 = class z {
  constructor(e, t) {
    ...
    this.testMode = !!(t != null && t.testMode), this.endpoint = Ae((a2 = t == null ? void 0 : t.endpoint) != null ? a2 : r2).origin, this.auth = new le(this), this.user = new he$1(this), this.wallet = new Ee(this), this.nft = new Re(this), this.rpcProvider = new ye(this);
    let s = Bn.call(this, t);
    this.parameters = ne$1(Z({ API_KEY: this.apiKey, DOMAIN_ORIGIN: window.location ? window.location.origin : "", ETH_NETWORK: t == null ? void 0 : t.network, host: Ae(this.endpoint).host, sdk: Ze$1[h.sdkName], version: o2, ext: se$2(s) ? void 0 : s, locale: (t == null ? void 0 : t.locale) || "en_US" }, h.bundleId ? { bundleId: h.bundleId } : {}));
  }
  get overlay() {
    if (!z$1.__overlays__.has(this.parameters)) {
      let e = new h.ViewController(this.endpoint, this.parameters);
      e.init(), z$1.__overlays__.set(this.parameters, e);
    }
    return z$1.__overlays__.get(this.parameters);
  }
  preload() {
    return x(this, null, function* () {
...
Te$1.__overlays__ = /* @__PURE__ */ new Map();
function Hn(n, e) {
...
var ve = ((b2) => typeof require != "undefined" ? require : typeof Proxy != "undefined" ? new Proxy(b2, { get: (A, R) => (typeof require != "undefined" ? require : A)[R] }) : b2)(function(b2) {
  if (typeof require != "undefined") return require.apply(this, arguments);
  throw new Error('Dynamic require of "' + b2 + '" is not supported');
});
var $e2 = (b2, A) => () => (A || b2((A = { exports: {} }).exports, A), A.exports);
var tt = (b2, A, R, L2) => {
  if (A && typeof A == "object" || typeof A == "function") for (let D2 of kr(A)) !rt.call(b2, D2) && D2 !== R && Je(b2, D2, { get: () => A[D2], enumerable: !(L2 = qr(A, D2)) || L2.enumerable });
  return b2;
};
var Ze = (b2, A, R) => (R = b2 != null ? Zr(et(b2)) : {}, tt(!b2 || !b2.__esModule ? Je(R, "default", { value: b2, enumerable: true }) : R, b2));
var se$1 = (b2, A, R) => new Promise((L2, D2) => {
  var X2 = (I2) => {
    try {
      Y2(R.next(I2));
    } catch (M3) {
  ...
  }, Y2 = (I2) => I2.done ? L2(I2.value) : Promise.resolve(I2.value).then(X2, P);
  Y2((R = R.apply(b2, A)).next());
});
var ke = $e2((qe2, Ne2) => {
  (function(b2) {
    if (typeof qe2 == "object" && typeof Ne2 < "u") Ne2.exports = b2();
    else if (typeof define == "function" && define.amd) define([], b2);
    else {
      var A;
      typeof window < "u" ? A = window : typeof global < "u" ? A = global : typeof self < "u" ? A = self : A = this, A.localforage = b2();
    }
  })(function() {
    return function L2(D2, X2, P) {
      function Y2(H2, $3) {
        if (!X2[H2]) {
          if (!D2[H2]) {
            var m2 = typeof ve == "function" && ve;
            if (!$3 && m2) return m2(H2, true);
            if (I2) return I2(H2, true);
            var _2 = new Error("Cannot find module '" + H2 + "'");
            throw _2.code = "MODULE_NOT_FOUND", _2;
          }
          var B = X2[H2] = { exports: {} };
          D2[H2][0].call(B.exports, function(z3) {
            var Z2 = D2[H2][1][z3];
            return Y2(Z2 || z3);
          }, B, B.exports, L2, D2, X2, P);
        }
        return X2[H2].exports;
      }
      for (var I2 = typeof ve == "function" && ve, M3 = 0; M3 < P.length; M3++) Y2(P[M3]);
      return Y2;
    }({ 1: [function(L2, D2, X2) {
      (function(P) {
        var Y2 = P.MutationObserver || P.WebKitMutationObserver, I2;
        if (Y2) {
          var M3 = 0, H2 = new Y2(z3), $3 = P.document.createTextNode("");
          H2.observe($3, { characterData: true }), I2 = function() {
            $3.data = M3 = ++M3 % 2;
          };
        } else if (!P.setImmediate && typeof P.MessageChannel < "u") {
          var m2 = new P.MessageChannel();
          m2.port1.onmessage = z3, I2 = function() {
            m2.port2.postMessage(0);
          };
        } else "document" in P && "onreadystatechange" in P.document.createElement("script") ? I2 = function() {
      ...
      var I2 = {}, M3 = ["REJECTED"], H2 = ["FULFILLED"], $3 = ["PENDING"];
      D2.exports = m2;
      function m2(h2) {
        if (typeof h2 != "function") throw new TypeError("resolver must be a function");
        this.state = $3, this.queue = [], this.outcome = void 0, h2 !== Y2 && Z2(this, h2);
      }
      m2.prototype.catch = function(h2) {
        return this.then(null, h2);
      }, m2.prototype.then = function(h2, N2) {
        if (typeof h2 != "function" && this.state === H2 || typeof N2 != "function" && this.state === M3) return this;
        var E3 = new this.constructor(Y2);
        if (this.state !== $3) {
          var O2 = this.state === H2 ? h2 : N2;
          B(E3, O2, this.outcome);
        } else this.queue.push(new _2(E3, h2, N2));
        return E3;
      };
      function _2(h2, N2, E3) {
        this.promise = h2, typeof N2 == "function" && (this.onFulfilled = N2, this.callFulfilled = this.otherCallFulfilled), typeof E3 == "function" && (this.onRejected = E3, this.callRejected = this.otherCallRejected);
      }
      ...
      I2.resolve = function(h2, N2) {
        var E3 = F2(z3, N2);
        if (E3.status === "error") return I2.reject(h2, E3.value);
        var O2 = E3.value;
        if (O2) Z2(h2, O2);
        else {
          h2.state = H2, h2.outcome = N2;
          for (var V2 = -1, j2 = h2.queue.length; ++V2 < j2; ) h2.queue[V2].callFulfilled(N2);
        }
        return h2;
      }, I2.reject = function(h2, N2) {
        h2.state = M3, h2.outcome = N2;
        for (var E3 = -1, O2 = h2.queue.length; ++E3 < O2; ) h2.queue[E3].callRejected(N2);
        return h2;
      };
      function z3(h2) {
        var N2 = h2 && h2.then;
        if (h2 && (typeof h2 == "object" || typeof h2 == "function") && typeof N2 == "function") return function() {
      ...
      function F2(h2, N2) {
        var E3 = {};
        try {
          E3.value = h2(N2), E3.status = "success";
        } catch (O2) {
      ...
      m2.resolve = k2;
      function k2(h2) {
        return h2 instanceof this ? h2 : I2.resolve(new this(Y2), h2);
      }
      m2.reject = U;
      function U(h2) {
        var N2 = new this(Y2);
        return I2.reject(N2, h2);
      }
      m2.all = ae2;
      function ae2(h2) {
        var N2 = this;
        if (Object.prototype.toString.call(h2) !== "[object Array]") return this.reject(new TypeError("must be an array"));
        var E3 = h2.length, O2 = false;
        if (!E3) return this.resolve([]);
        for (var V2 = new Array(E3), j2 = 0, Q2 = -1, J3 = new this(Y2); ++Q2 < E3; ) ee2(h2[Q2], Q2);
        return J3;
        function ee2(oe2, a2) {
          N2.resolve(oe2).then(s, function(v) {
            O2 || (O2 = true, I2.reject(J3, v));
          });
          function s(v) {
            V2[a2] = v, ++j2 === E3 && !O2 && (O2 = true, I2.resolve(J3, V2));
          }
        }
      }
      m2.race = re2;
      function re2(h2) {
        ...
        var E3 = h2.length, O2 = false;
        if (!E3) return this.resolve([]);
        for (var V2 = -1, j2 = new this(Y2); ++V2 < E3; ) Q2(h2[V2]);
        return j2;
        function Q2(J3) {
          N2.resolve(J3).then(function(ee2) {
            O2 || (O2 = true, I2.resolve(j2, ee2));
          }, function(ee2) {
            O2 || (O2 = true, I2.reject(j2, ee2));
          });
        }
      }
      ...
      function $3(e, t) {
        ...
        try {
          ...
          for (var r2 = typeof BlobBuilder < "u" ? BlobBuilder : typeof MSBlobBuilder < "u" ? MSBlobBuilder : typeof MozBlobBuilder < "u" ? MozBlobBuilder : WebKitBlobBuilder, o2 = new r2(), i = 0; i < e.length; i += 1) o2.append(e[i]);
      ...
      function N2(e) {
        for (var t = e.length, r2 = new ArrayBuffer(t), o2 = new Uint8Array(r2), i = 0; i < t; i++) o2[i] = e.charCodeAt(i);
        return r2;
      }
      function E3(e) {
      ...
      function O2(e) {
        return typeof k2 == "boolean" ? m2.resolve(k2) : E3(e).then(function(t) {
          return k2 = t, k2;
        });
      }
      function V2(e) {
        var t = U[e.name], r2 = {};
        r2.promise = new m2(function(o2, i) {
      ...
      function j2(e) {
        ...
        if (r2) return r2.resolve(), r2.promise;
      }
      function Q2(e, t) {
        var r2 = U[e.name], o2 = r2.deferredOperations.pop();
        if (o2) return o2.reject(t), o2.promise;
      }
      function J3(e, t) {
        return new m2(function(r2, o2) {
          if (U[e.name] = U[e.name] || G2(), e.db) if (t) V2(e), e.db.close();
          else return r2(e.db);
          var i = [e.name];
          t && i.push(e.version);
          ...
          t && (n.onupgradeneeded = function(f) {
            ...
            try {
              ...
              if (c2.name === "ConstraintError") console.warn('The database "' + e.name + '" has been upgraded from version ' + f.oldVersion + " to version " + f.newVersion + ', but the storage "' + e.storeName + '" already exists.');
              else throw c2;
            }
      ...
      function g2(e) {
        var t = this, r2 = t._initReady().then(function() {
          ...
          if (o2 && o2.dbReady) return o2.dbReady;
        });
        return B(r2, e, e), r2;
      }
      function w2(e) {
        ...
        return e.db = null, ee2(e).then(function(n) {
          ...
          e.db = t.db = n;
          for (var f = 0; f < r2.length; f++) r2[f]._dbInfo.db = n;
        }).catch(function(n) {
          throw Q2(e, n), n;
        });
      }
      function T2(e, t, r2, o2) {
        o2 === void 0 && (o2 = 1);
        try {
          var i = e.db.transaction(e.storeName, t);
          r2(null, i);
        } catch (n) {
          if (o2 > 0 && (!e.db || n.name === "InvalidStateError" || n.name === "NotFoundError")) return m2.resolve().then(function() {
      ...
      function fe2(e) {
        ...
        if (e) for (var o2 in e) r2[o2] = e[o2];
        var i = U[r2.name];
      ...
      function ie2(e, t) {
        var r2 = this;
        e = z3(e);
        var o2 = new m2(function(i, n) {
          r2.ready().then(function() {
            T2(r2._dbInfo, re2, function(f, u2) {
              if (f) return n(f);
              try {
      ...
      function ce2(e, t) {
        var r2 = this, o2 = new m2(function(i, n) {
          r2.ready().then(function() {
            T2(r2._dbInfo, re2, function(f, u2) {
              if (f) return n(f);
              try {
      ...
      function nr(e, t, r2) {
        var o2 = this;
        e = z3(e);
        var i = new m2(function(n, f) {
          var u2;
          o2.ready().then(function() {
            return u2 = o2._dbInfo, ae2.call(t) === "[object Blob]" ? O2(u2.db).then(function(c2) {
              return c2 ? t : s(t);
            }) : t;
          }).then(function(c2) {
            T2(o2._dbInfo, h2, function(l, d2) {
              if (l) return f(l);
              try {
      ...
      function or(e, t) {
        ...
        var o2 = new m2(function(i, n) {
          r2.ready().then(function() {
            T2(r2._dbInfo, h2, function(f, u2) {
              if (f) return n(f);
              try {
      ...
      function ir(e) {
        var t = this, r2 = new m2(function(o2, i) {
          t.ready().then(function() {
            T2(t._dbInfo, h2, function(n, f) {
              if (n) return i(n);
              try {
      ...
      function sr(e, t) {
        ...
        var o2 = this, i;
        if (!e.name) i = m2.reject("Invalid arguments");
        else {
          var n = e.name === r2.name && o2._dbInfo.db, f = n ? m2.resolve(o2._dbInfo.db) : ee2(e).then(function(u2) {
            var c2 = U[e.name], l = c2.forages;
            c2.db = u2;
            for (var d2 = 0; d2 < l.length; d2++) l[d2]._dbInfo.db = u2;
            return u2;
          });
          e.storeName ? i = f.then(function(u2) {
            if (!!u2.objectStoreNames.contains(e.storeName)) {
              ...
              return x2.then(function(C2) {
                ...
                throw (Q2(e, C2) || m2.resolve()).catch(function() {
                }), C2;
              });
            }
            ...
            var S2 = new m2(function(x2, C2) {
              var K2 = M3.deleteDatabase(e.name);
              K2.onerror = function() {
                var W2 = K2.result;
      ...
      var cr = { _driver: "asyncStorage", _initStorage: fe2, _support: H2(), iterate: ce2, getItem: ie2, setItem: nr, removeItem: or, clear: ir, length: ar, key: fr, keys: ur, dropInstance: sr };
      function lr() {
        return typeof openDatabase == "function";
      }
      var te2 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", dr2 = "~~local_forage_type~", Be2 = /^~~local_forage_type~([^~]+)~/, he3 = "__lfsc__:", be = he3.length, _e2 = "arbf", we2 = "blob", xe2 = "si08", Oe2 = "ui08", Ce2 = "uic8", Le2 = "si16", Pe2 = "si32", Me2 = "ur16", Fe2 = "ui32", Ue2 = "fl32", Ye2 = "fl64", ze2 = be + _e2.length, We2 = Object.prototype.toString;
      function Ke2(e) {
        var t = e.length * 0.75, r2 = e.length, o2, i = 0, n, f, u2, c2;
        e[e.length - 1] === "=" && (t--, e[e.length - 2] === "=" && t--);
        var l = new ArrayBuffer(t), d2 = new Uint8Array(l);
        for (o2 = 0; o2 < r2; o2 += 4) n = te2.indexOf(e[o2]), f = te2.indexOf(e[o2 + 1]), u2 = te2.indexOf(e[o2 + 2]), c2 = te2.indexOf(e[o2 + 3]), d2[i++] = n << 2 | f >> 4, d2[i++] = (f & 15) << 4 | u2 >> 2, d2[i++] = (u2 & 3) << 6 | c2 & 63;
        return l;
      }
      function Ee2(e) {
        var t = new Uint8Array(e), r2 = "", o2;
        for (o2 = 0; o2 < t.length; o2 += 3) r2 += te2[t[o2] >> 2], r2 += te2[(t[o2] & 3) << 4 | t[o2 + 1] >> 4], r2 += te2[(t[o2 + 1] & 15) << 2 | t[o2 + 2] >> 6], r2 += te2[t[o2 + 2] & 63];
      ...
      function hr(e) {
        if (e.substring(0, be) !== he3) return JSON.parse(e);
      ...
      function mr2(e) {
        var t = this, r2 = { db: null };
        if (e) for (var o2 in e) r2[o2] = typeof e[o2] != "string" ? e[o2].toString() : e[o2];
        var i = new m2(function(n, f) {
          try {
        ...
        return new m2(function(t, r2) {
          e.transaction(function(o2) {
            o2.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name <> '__WebKitDatabaseInfoTable__'", [], function(i, n) {
              for (var f = [], u2 = 0; u2 < n.rows.length; u2++) f.push(n.rows.item(u2).name);
              t({ db: e, storeNames: f });
            }, function(i, n) {
              r2(n);
            });
      ...
      function Ar(e, t) {
        ...
        return e.name ? i = new m2(function(n) {
          ...
          return new m2(function(f, u2) {
            n.db.transaction(function(c2) {
              function l(x2) {
                return new m2(function(C2, K2) {
              ...
              for (var d2 = [], y2 = 0, S2 = n.storeNames.length; y2 < S2; y2++) d2.push(l(n.storeNames[y2]));
              m2.all(d2).then(function() {
                f();
              }).catch(function(x2) {
                u2(x2);
              });
        ...
        }) : i = m2.reject("Invalid arguments"), _2(i, t), i;
      }
      ...
      function Br(e) {
        var t = this, r2 = {};
        if (e) for (var o2 in e) r2[o2] = e[o2];
        return r2.keyPrefix = Ge2(e, t._defaultConfig), Tr() ? (t._dbInfo = r2, r2.serializer = Ie2, m2.resolve()) : m2.reject();
      }
      function xr(e) {
        ...
        var r2 = this, o2 = r2.ready().then(function() {
          for (var i = r2._dbInfo, n = i.keyPrefix, f = n.length, u2 = localStorage.length, c2 = 1, l = 0; l < u2; l++) {
            ...
            if (d2.indexOf(n) === 0) {
              ...
              if (y2 && (y2 = i.serializer.deserialize(y2)), y2 = e(y2, d2.substring(f), c2++), y2 !== void 0) return y2;
            }
          }
        });
        return _2(o2, t), o2;
      ...
      function Ae2() {
        for (var e = 1; e < arguments.length; e++) {
          var t = arguments[e];
          if (t) for (var r2 in t) t.hasOwnProperty(r2) && (je2(t[r2]) ? arguments[0][r2] = t[r2].slice() : arguments[0][r2] = t[r2]);
        }
        return arguments[0];
      }
      var jr = function() {
        function e(t) {
          Y2(this, e);
          for (var r2 in ue2) if (ue2.hasOwnProperty(r2)) {
        ...
        return e.prototype.config = function(r2) {
          if ((typeof r2 > "u" ? "undefined" : P(r2)) === "object") {
            ...
            for (var o2 in r2) {
              if (o2 === "storeName" && (r2[o2] = r2[o2].replace(/\W/g, "_")), o2 === "version" && typeof r2[o2] != "number") return new Error("Database version must be a number.");
              this._config[o2] = r2[o2];
            }
            return "driver" in r2 && r2.driver ? this.setDriver(this._config.driver) : true;
          } else return typeof r2 == "string" ? this._config[r2] : this._config;
          ...
          var n = le2[r2] ? m2.resolve(le2[r2]) : m2.reject(new Error("Driver not found."));
          return B(n, o2, i), n;
        }, e.prototype.getSerializer = function(r2) {
          var o2 = m2.resolve(Ie2);
          return B(o2, r2), o2;
          ...
          return this._driverSet = d2.then(function() {
            ...
            return n._driverSet = m2.reject(y2), n._driverSet;
          ...
          for (var r2 = 0, o2 = Se2.length; r2 < o2; r2++) Gr(this, Se2[r2]);
  ...
  (function(b2, A) {
    ...
    function L2(a2, s) {
      ...
      try {
        ...
        for (var v = typeof BlobBuilder < "u" ? BlobBuilder : typeof MSBlobBuilder < "u" ? MSBlobBuilder : typeof MozBlobBuilder < "u" ? MozBlobBuilder : WebKitBlobBuilder, p2 = new v(), g2 = 0; g2 < a2.length; g2 += 1) p2.append(a2[g2]);
        return p2.getBlob(s.type);
      }
    }
    var D2 = /^~~local_forage_type~([^~]+)~/, X2 = 9, P = X2 + 4, Y2 = Object.prototype.toString;
    function I2(a2) {
      var s = a2.length * 0.75, v = a2.length;
      a2[a2.length - 1] === "=" && (s--, a2[a2.length - 2] === "=" && s--);
      for (var p2 = new ArrayBuffer(s), g2 = new Uint8Array(p2), w2 = 0, T2 = 0; w2 < v; w2 += 4) {
    ...
    function H2(a2, s) {
      ...
      if (a2 && (v = Y2.call(a2)), a2 && (v === "[object ArrayBuffer]" || a2.buffer && Y2.call(a2.buffer) === "[object ArrayBuffer]")) {
        ...
        w2.onload = function() {
          var T2 = "~~local_forage_type~" + a2.type + "~" + M3(this.result);
          s("__lfsc__:blob" + T2);
        }, w2.readAsArrayBuffer(a2);
      } else try {
        s(JSON.stringify(a2));
      } catch (T2) {
        console.error("Couldn't convert value into a JSON string: ", a2), s(null, T2);
      }
    }
    function $3(a2) {
    ...
    function m2(a2) {
      ...
      try {
        for (var g2 = R(Object.keys(a2)), w2 = g2.next(); !w2.done; w2 = g2.next()) {
          var T2 = w2.value;
          Object.prototype.hasOwnProperty.call(a2, T2) && (a2.isActiveClone = null, p2[T2] = m2(a2[T2]), delete a2.isActiveClone);
        }
      } catch (G2) {
        s = { error: G2 };
      } finally {
    ...
    var k2 = { bufferToString: M3, deserialize: $3, serialize: H2, stringToBuffer: I2 }, U = {}, ae2 = function() {
      function a2(s) {
        this.kp = s, this.data = {};
      }
    ...
    function re2(a2) {
      var s = a2 ? m2(a2) : {}, v = _2(s, this._defaultConfig), p2 = ae2.resolve(v);
      return this._dbInfo = s, this._dbInfo.serializer = k2, this._dbInfo.keyPrefix = v, this._dbInfo.mStore = p2, Promise.resolve();
    }
    function h2(a2) {
    ...
    function N2(a2, s) {
      var v = Z2.apply(this, arguments), p2 = v.promise, g2 = v.callback, w2 = p2.then(function(T2) {
        ae2.resolve(T2).drop();
      });
      return B(w2, g2), p2;
    }
    ...
    function O2(a2, s) {
      var v = this, p2 = this.ready().then(function() {
        for (var g2 = v._dbInfo.mStore, w2 = g2.keys(), T2 = 0; T2 < w2.length; T2++) {
          var G2 = g2.get(w2[T2]);
          if (G2 && (G2 = v._dbInfo.serializer.deserialize(G2)), G2 = a2(G2, w2[T2], T2 + 1), G2 !== void 0) return G2;
        }
      });
      return B(p2, s), p2;
    }
    ...
    function ee2(a2, s, v) {
      ...
      var g2 = this.ready().then(function() {
        s === void 0 && (s = null);
        var w2 = s;
        return new Promise(function(T2, G2) {
          p2._dbInfo.serializer.serialize(s, function(fe2, ie2) {
            if (ie2) G2(ie2);
            else try {
              p2._dbInfo.mStore.set(a2, fe2), T2(w2);
            } catch (ce2) {
              G2(ce2);
            }
          });
    ...
    var oe2 = true;
    b2._support = oe2, b2._driver = A, b2._initStorage = re2, b2.clear = h2, b2.dropInstance = N2, b2.getItem = E3, b2.iterate = O2, b2.key = V2, b2.keys = j2, b2.length = Q2, b2.removeItem = J3, b2.setItem = ee2, Object.defineProperty(b2, "__esModule", { value: true });
  });
});
var ge2 = Ze(ke()), Te = Ze(rr());
var at = { display: "none", position: "fixed", top: "0", right: "0", width: "100%", height: "100%", borderRadius: "0", border: "none", zIndex: "2147483647" };
function ft(b2) {
  for (let [A, R] of Object.entries(at)) b2.style[A] = R;
}
function ut(b2) {
  let A = [].slice.call(document.querySelectorAll(".magic-iframe"));
  return Boolean(A.find((R) => R.src.includes(b2)));
}
var pe$1 = class pe extends Se {
  constructor() {
    super(...arguments);
  ...
  init() {
    this.test = "hello", this.iframe = new Promise((R) => {
      let L2 = () => {
        if (ut(encodeURIComponent(this.parameters))) mr().log();
        else {
          let D2 = document.createElement("iframe");
          D2.classList.add("magic-iframe"), D2.dataset.magicIframeLabel = Ae(this.endpoint).host, D2.title = "Secure Modal", D2.src = Ae(`/send?params=${encodeURIComponent(this.parameters)}`, this.endpoint).href, ft(D2), document.body.appendChild(D2), R(D2);
        }
      };
      ...
      if (R.origin === this.endpoint && R.data && R.data.msgType && this.messageHandlers.size) {
        ...
        for (let D2 of this.messageHandlers.values()) D2(R);
      }
    });
  }
  showOverlay() {
    return se$1(this, null, function* () {
  ...
  _post(R) {
    return se$1(this, null, function* () {
      ...
      if (L2 && L2.contentWindow) L2.contentWindow.postMessage(R, this.endpoint);
      else throw dr();
    });
  }
};
var bt = In(Te$1, { platform: "web", sdkName: "magic-sdk", version: "13.6.2", defaultEndpoint: "https://auth.magic.link/", ViewController: pe$1, configureStorage: () => se$1(void 0, null, function* () {
  let b2 = ge2.default.createInstance({ name: "MagicAuthLocalStorageDB", storeName: "MagicAuthLocalStorage" });
  return yield b2.defineDriver(Te), yield b2.setDriver([ge2.default.INDEXEDDB, ge2.default.LOCALSTORAGE, Te._driver]), b2;
}) });
...
var H = (n, r2) => () => (r2 || n((r2 = { exports: {} }).exports, r2), r2.exports);
var se = (n, r2, s, m2) => {
  if (r2 && typeof r2 == "object" || typeof r2 == "function") for (let h2 of ie(r2)) !oe.call(n, h2) && h2 !== s && D(n, h2, { get: () => r2[h2], enumerable: !(m2 = ne(r2, h2)) || m2.enumerable });
  return n;
};
var T = (n, r2, s) => (s = n != null ? te(ae(n)) : {}, se(!n || !n.__esModule ? D(s, "default", { value: n, enumerable: true }) : s, n));
var C = (n, r2, s) => new Promise((m2, h2) => {
  var w2 = (p2) => {
    try {
      d2(s.next(p2));
    } catch (u2) {
  ...
  }, d2 = (p2) => p2.done ? m2(p2.value) : Promise.resolve(p2.value).then(w2, R);
...
var k = H((I2, F2) => {
  (function(n, r2) {
    ...
    var n = n || function(r2, s) {
      var m2 = Object.create || /* @__PURE__ */ function() {
        function e() {
        }
        return function(t) {
          var c2;
        ...
        if (this.clamp(), i % 4) for (var v = 0; v < g2; v++) {
          var b2 = c2[v >>> 2] >>> 24 - v % 4 * 8 & 255;
          t[i + v >>> 2] |= b2 << 24 - (i + v) % 4 * 8;
        }
        else for (var v = 0; v < g2; v += 4) t[i + v >>> 2] = c2[v >>> 2];
        ...
        for (var t = e.length, c2 = [], i = 0; i < t; i += 2) c2[i >>> 3] |= parseInt(e.substr(i, 2), 16) << 24 - i % 8 * 4;
        ...
        for (var t = e.length, c2 = [], i = 0; i < t; i++) c2[i >>> 2] |= (e.charCodeAt(i) & 255) << 24 - i % 4 * 8;
        ...
        if (y2) {
          for (var B = 0; B < y2; B += g2) this._doProcessBlock(c2, B);
      ...
      w2.Hasher = f.extend({ cfg: R.extend(), init: function(e) {
...
var z2 = H((S2, W2) => {
  (function(n, r2) {
    typeof S2 == "object" ? W2.exports = S2 = r2(k()) : typeof define == "function" && define.amd ? define(["./core"], r2) : r2(n.CryptoJS);
  })(S2, function(n) {
    return function(r2) {
      var s = n, m2 = s.lib, h2 = m2.WordArray, w2 = m2.Hasher, R = s.algo, d2 = [], p2 = [];
      (function() {
        function a2(e) {
          for (var t = r2.sqrt(e), c2 = 2; c2 <= t; c2++) if (!(e % c2)) return false;
          return true;
        }
        function f(e) {
          return (e - (e | 0)) * 4294967296 | 0;
        }
        for (var o2 = 2, l = 0; l < 64; ) a2(o2) && (l < 8 && (d2[l] = f(r2.pow(o2, 1 / 2))), p2[l] = f(r2.pow(o2, 1 / 3)), l++), o2++;
      })();
...
var q2 = H((U, L2) => {
  (function(n, r2) {
    typeof U == "object" ? L2.exports = U = r2(k()) : typeof define == "function" && define.amd ? define(["./core"], r2) : r2(n.CryptoJS);
  })(U, function(n) {
    return function() {
      var r2 = n, s = r2.lib, m2 = s.WordArray, h2 = r2.enc;
      h2.Base64 = { stringify: function(d2) {
        var p2 = d2.words, u2 = d2.sigBytes, _2 = this._map;
        d2.clamp();
        for (var a2 = [], f = 0; f < u2; f += 3) for (var o2 = p2[f >>> 2] >>> 24 - f % 4 * 8 & 255, l = p2[f + 1 >>> 2] >>> 24 - (f + 1) % 4 * 8 & 255, e = p2[f + 2 >>> 2] >>> 24 - (f + 2) % 4 * 8 & 255, t = o2 << 16 | l << 8 | e, c2 = 0; c2 < 4 && f + c2 * 0.75 < u2; c2++) a2.push(_2.charAt(t >>> 6 * (3 - c2) & 63));
        var i = _2.charAt(64);
        if (i) for (; a2.length % 4; ) a2.push(i);
        return a2.join("");
      }, parse: function(d2) {
        var p2 = d2.length, u2 = this._map, _2 = this._reverseMap;
        if (!_2) {
          _2 = this._reverseMap = [];
          for (var a2 = 0; a2 < u2.length; a2++) _2[u2.charCodeAt(a2)] = a2;
        }
        var f = u2.charAt(64);
        if (f) {
          var o2 = d2.indexOf(f);
      ...
      function R(d2, p2, u2) {
        for (var _2 = [], a2 = 0, f = 0; f < p2; f++) if (f % 4) {
          var o2 = u2[d2.charCodeAt(f - 1)] << f % 4 * 2, l = u2[d2.charCodeAt(f)] >>> 6 - f % 4 * 2;
          _2[a2 >>> 2] |= (o2 | l) << 24 - a2 % 4 * 8, a2++;
        }
        return m2.create(_2, a2);
      }
    }(), n.enc.Base64;
  });
});
var E2 = ((r2) => (r2.ParseRedirectResult = "magic_oauth_parse_redirect_result", r2))(E2 || {}), ce = ((a2) => (a2.InvalidRequest = "invalid_request", a2.InvalidClient = "invalid_client", a2.InvalidScope = "invalid_scope", a2.InvalidGrant = "invalid_grant", a2.UnauthorizedClient = "unauthorized_client", a2.UnsupportedResponseType = "unsupported_response_type", a2.UnsupportedGrantType = "unsupported_grant_type", a2.UnsupportedTokenType = "unsupported_token_type", a2.AccessDenied = "access_denied", a2.ServerError = "server_error", a2.TemporarilyUnavailable = "temporarily_unavailable", a2))(ce || {});
var j = T(z2()), J2 = T(q2());
var $2 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-._~", V = typeof window != "undefined" && !!window.crypto, fe = V && !!window.crypto.subtle;
function ue(n) {
...
function M2(n) {
  ...
  if (n instanceof ArrayBuffer) {
    let s = new Uint8Array(n), m2 = Array.from(s).map((w2) => String.fromCharCode(w2)).join(""), h2 = btoa(m2);
    return r2(h2);
  }
...
function de(n) {
  return C(this, null, function* () {
    ...
    return M2((0, j.default)(n));
  });
}
function N(n) {
  let r2 = new Uint8Array(n);
  if (V) window.crypto.getRandomValues(r2);
  else for (let s = 0; s < n; s += 1) r2[s] = Math.floor(Math.random() * Math.floor(255));
  return ue(r2);
}
function K() {
  return C(this, null, function* () {
    let n = N(128), r2 = N(128), s = yield de(r2);
    return { verifier: r2, challenge: s, state: n };
  });
}
var Y = class extends w.Internal {
  constructor() {
    super(...arguments);
    this.name = "oauth";
    this.config = {};
  ...
  loginWithRedirect(s) {
    return this.utils.createPromiEvent((m2) => C(this, null, function* () {
      let { provider: h2, query: w2 } = yield pe2.call(this, s);
      window.location.href = new URL(`/v1/oauth2/${h2}/start?${w2}`, this.sdk.endpoint).href, m2();
    }));
  }
  getRedirectResult() {
    let s = window.location.search, m2 = window.location.origin + window.location.pathname;
    return window.history.replaceState(null, "", m2), he2.call(this, s);
  }
}, O = "oauth_redirect_metadata";
function pe2(n) {
  return C(this, null, function* () {
    yield this.utils.storage.removeItem(O);
    let { provider: r2, redirectURI: s, scope: m2, loginHint: h2 } = n, { verifier: w2, challenge: R, state: d2 } = yield K(), p2 = JSON.stringify({ verifier: w2, state: d2 });
    return yield this.utils.storage.setItem(O, p2), { query: [`magic_api_key=${encodeURIComponent(this.sdk.apiKey)}`, `magic_challenge=${encodeURIComponent(R)}`, `state=${encodeURIComponent(d2)}`, `platform=${encodeURIComponent("web")}`, m2 && `scope=${encodeURIComponent(m2.join(" "))}`, s && `redirect_uri=${encodeURIComponent(s)}`, h2 && `login_hint=${encodeURIComponent(h2)}`].reduce((_2, a2) => a2 ? `${_2}&${a2}` : _2), provider: r2, redirectURI: s };
  });
}
function he2(n) {
  return this.utils.createPromiEvent((r2, s) => C(this, null, function* () {
    var _2;
    let m2 = yield this.utils.storage.getItem(O), { verifier: h2, state: w2 } = JSON.parse(m2);
