...
import { ab as FEATURE_NFT, aR as AddressZero, X as resolveAddress, o as buildTransactionFunction, T as Transaction, bh as FEATURE_NFT_SUPPLY, B as BigNumber, bi as FEATURE_NFT_MINTABLE, bj as FEATURE_NFT_BATCH_MINTABLE, bk as FEATURE_NFT_BURNABLE, bl as FEATURE_NFT_LOYALTY_CARD, bm as FEATURE_NFT_LAZY_MINTABLE, bn as FEATURE_NFT_UPDATABLE_METADATA, aA as ExtensionNotImplementedError, bo as FEATURE_NFT_CLAIM_CUSTOM, bp as FEATURE_NFT_CLAIM_CONDITIONS_V2, bq as FEATURE_NFT_TIERED_DROP, br as FEATURE_NFT_SIGNATURE_MINTABLE_V2, bs as FEATURE_NFT_REVEALABLE, bt as FEATURE_NFT_SHARED_METADATA, b1 as NotFoundError, a3 as CustomContractSchema, bu as FEATURE_NFT_CLAIM_ZORA, t as toUtf8Bytes, bv as isFileOrBuffer, aJ as keccak256, aK as defaultAbiCoder, y as invariant, aM as normalizePriceValue, a2 as ContractEncoder, V as parseEther, $ as AmountSchema, bw as FEATURE_NFT_ENUMERABLE, bx as FEATURE_NFT_QUERYABLE, Z as z, a0 as AddressOrEnsSchema, by as BasisPointsSchema, bz as BigNumberSchema } from "./index-R4o_uq0C.js";
import { a as assertEnabled } from "./assertEnabled-d1700f0b.browser.esm-DFK6vCrZ.js";
import { h as hasFunction, d as detectContractFeature, a as ContractMetadata } from "./contract-appuri-5c40af52.browser.esm-FEDBCqrq.js";
import { F as FALLBACK_METADATA, a as fetchTokenMetadata, u as uploadOrExtractURIs, g as getBaseUriFromBatch, b as uploadOrExtractURI, D as DEFAULT_QUERY_ALL_COUNT } from "./QueryParams-32a56510.browser.esm-BJnH1Vvy.js";
...
import { B as BasicNFTInput, C as CommonNFTInput, s as setErc20Allowance } from "./setErc20Allowance-7f76f677.browser.esm-LDt0ehVI.js";
import { o as Signature721WithQuantityInput, q as Signature721WithQuantityOutput, s as MintRequest721, v as MintRequest721withQuantity, B as BaseSignaturePayloadInput } from "./index-MMLm2ukI.js";
class Erc721Burnable {
  constructor(contractWrapper) {
     ...
     * ```
     */
    __publicField(this, "token", /* @__PURE__ */ buildTransactionFunction(async (tokenId) => {
...
class Erc721ClaimableWithConditions {
  ...
  constructor(erc721, contractWrapper, storage) {
     ...
     */
    __publicField(this, "to", /* @__PURE__ */ buildTransactionFunction(async (destinationAddress, quantity, options) => {
...
class Erc721LoyaltyCard {
  constructor(contractWrapper) {
     ...
     * ```
     */
    __publicField(this, "cancel", /* @__PURE__ */ buildTransactionFunction(async (tokenId) => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "cancel",
        args: [tokenId]
     ...
     * ```
     */
    __publicField(this, "revoke", /* @__PURE__ */ buildTransactionFunction(async (tokenId) => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "revoke",
        args: [tokenId]
...
class Erc721UpdatableMetadata {
  constructor(contractWrapper, storage) {
     ...
     * ```
     */
    __publicField(this, "update", /* @__PURE__ */ buildTransactionFunction(async (tokenId, metadata) => {
...
class Erc721BatchMintable {
  constructor(erc721, contractWrapper, storage) {
     ...
     * ```
     */
    __publicField(this, "to", /* @__PURE__ */ buildTransactionFunction(async (to, metadatas) => {
...
class Erc721Mintable {
  constructor(erc721, contractWrapper, storage) {
     ...
     * ```
     */
    __publicField(this, "to", /* @__PURE__ */ buildTransactionFunction(async (to, metadata) => {
...
class Erc721SharedMetadata {
  constructor(contractWrapper, storage) {
     ...
     * @returns  Receipt for the transaction
     */
    __publicField(this, "set", /* @__PURE__ */ buildTransactionFunction(async (metadata) => {
...
class Erc721TieredDrop {
  constructor(erc721, contractWrapper, storage) {
    ...
    __publicField(this, "createBatchWithTier", /* @__PURE__ */ buildTransactionFunction(async (metadatas, tier, options) => {
      const startFileNumber = await this.erc721.nextTokenIdToMint();
      const batch = await uploadOrExtractURIs(metadatas, this.storage, startFileNumber.toNumber(), options);
      const baseUri = getBaseUriFromBatch(batch);
      return Transaction.fromContractWrapper({
    ...
    __publicField(this, "createDelayedRevealBatchWithTier", /* @__PURE__ */ buildTransactionFunction(async (placeholder, metadatas, password, tier, options) => {
      if (!password) {
...
class Erc721 {
  constructor(contractWrapper, storage, chainId) {
     ...
     * @twfeature ERC721
     */
    __publicField(this, "transfer", /* @__PURE__ */ buildTransactionFunction(async (to, tokenId) => {
     ...
     * @twfeature ERC721
     */
    __publicField(this, "transferFrom", /* @__PURE__ */ buildTransactionFunction(async (from, to, tokenId) => {
     ...
     * @internal
     */
    __publicField(this, "setApprovalForToken", /* @__PURE__ */ buildTransactionFunction(async (operator, tokenId) => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "approve",
     ...
     * @twfeature ERC721Mintable
     */
    __publicField(this, "mintTo", /* @__PURE__ */ buildTransactionFunction(async (receiver, metadata) => {
     ...
     * @twfeature ERC721BatchMintable
     */
    __publicField(this, "mintBatchTo", /* @__PURE__ */ buildTransactionFunction(async (receiver, metadatas) => {
      var _a;
  ...
  async getOwned(walletAddress, queryParams) {
    ...
    if ((_a = this.query) == null ? void 0 : _a.owned) {
      ...
      const ownedTokens = (allOwners || []).filter((i) => {
        var _a2;
...
export {
  Erc721 as E,
  Erc721WithQuantitySignatureMintable as a
};
