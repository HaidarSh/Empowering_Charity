...
import { ae as FEATURE_DIRECT_LISTINGS, a2 as ContractEncoder, B as BigNumber, X as resolveAddress, o as buildTransactionFunction, aM as normalizePriceValue, T as Transaction, y as invariant, bf as fetchCurrencyValue, c as __vitePreload, ai as Contract, af as FEATURE_ENGLISH_AUCTIONS, aR as AddressZero, b9 as fetchCurrencyMetadata, aF as formatUnits, bA as AuctionHasNotEndedError, ag as FEATURE_OFFERS, b7 as isNativeToken, bB as NATIVE_TOKENS, a1 as ContractWrapper, Z as z, a0 as AddressOrEnsSchema, bC as BigNumberishSchema, aN as NATIVE_TOKEN_ADDRESS, $ as AmountSchema } from "./index-R4o_uq0C.js";
import { c as cleanCurrencyAddress } from "./cleanCurrencyAddress-ded19cfe.browser.esm-BOEJqYJE.js";
import { s as setErc20Allowance } from "./setErc20Allowance-7f76f677.browser.esm-LDt0ehVI.js";
import { g as getAllInBatches, h as handleTokenApproval, i as isTokenApprovedForTransfer } from "./marketplace-e3129e2f.browser.esm-DnhYzV1W.js";
import { f as fetchTokenMetadataForContract, I as InterfaceId_IERC721, c as InterfaceId_IERC1155 } from "./QueryParams-32a56510.browser.esm-BJnH1Vvy.js";
import { R as RawDateSchema, E as EndDateSchema } from "./assertEnabled-d1700f0b.browser.esm-DFK6vCrZ.js";
import { C as ContractEvents, G as GasCostEstimator } from "./contract-appuri-5c40af52.browser.esm-FEDBCqrq.js";
...
class MarketplaceV3DirectListings {
  ...
  constructor(contractWrapper, storage) {
     ...
     */
    __publicField(this, "createListing", /* @__PURE__ */ buildTransactionFunction(async (listing) => {
     ...
     * ```
     */
    __publicField(this, "createListingsBatch", /* @__PURE__ */ buildTransactionFunction(async (listings) => {
     ...
     * @twfeature DirectListings
     */
    __publicField(this, "updateListing", /* @__PURE__ */ buildTransactionFunction(async (listingId, listing) => {
      const parsedListing = await DirectListingInputParamsSchema.parseAsync(listing);
      await handleTokenApproval(this.contractWrapper, this.getAddress(), parsedListing.assetContractAddress, parsedListing.tokenId, await this.contractWrapper.getSignerAddress());
      const normalizedPricePerToken = await normalizePriceValue(this.contractWrapper.getProvider(), parsedListing.pricePerToken, parsedListing.currencyContractAddress);
      const tx = Transaction.fromContractWrapper({
     ...
     * @twfeature DirectListings
     */
    __publicField(this, "cancelListing", /* @__PURE__ */ buildTransactionFunction(async (listingId) => {
      const tx = Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
     ...
     * @twfeature DirectListings
     */
    __publicField(this, "buyFromListing", /* @__PURE__ */ buildTransactionFunction(async (listingId, quantityDesired, receiver) => {
      if (receiver) {
     ...
     * @twfeature DirectListings
     */
    __publicField(this, "approveBuyerForReservedListing", /* @__PURE__ */ buildTransactionFunction(async (listingId, buyer) => {
     ...
     * @param buyer - Address of buyer being approved
     */
    __publicField(this, "revokeBuyerApprovalForReservedListing", /* @__PURE__ */ buildTransactionFunction(async (listingId, buyer) => {
      const isApproved = await this.isBuyerApprovedForListing(listingId, buyer);
      if (isApproved) {
        const tx = Transaction.fromContractWrapper({
          contractWrapper: this.contractWrapper,
     ...
     * @twfeature DirectListings
     */
    __publicField(this, "approveCurrencyForListing", /* @__PURE__ */ buildTransactionFunction(async (listingId, currencyContractAddress, pricePerTokenInCurrency) => {
      const listing = await this.validateListing(BigNumber.from(listingId));
     ...
     * @twfeature DirectListings
     */
    __publicField(this, "revokeCurrencyApprovalForListing", /* @__PURE__ */ buildTransactionFunction(async (listingId, currencyContractAddress) => {
      const listing = await this.validateListing(BigNumber.from(listingId));
      const resolvedCurrencyAddress = await resolveAddress(currencyContractAddress);
      if (resolvedCurrencyAddress === listing.currencyContractAddress) {
      ...
      const currencyPrice = await this.contractWrapper.read("currencyPriceForListing", [listingId, resolvedCurrencyAddress]);
      invariant(!currencyPrice.isZero());
      const tx = Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "approveCurrencyForListing",
...
class MarketplaceV3EnglishAuctions {
  ...
  constructor(contractWrapper, storage) {
     ...
     */
    __publicField(this, "createAuction", /* @__PURE__ */ buildTransactionFunction(async (auction) => {
     ...
     * ```
     */
    __publicField(this, "createAuctionsBatch", /* @__PURE__ */ buildTransactionFunction(async (listings) => {
     ...
     * @twfeature EnglishAuctions
     */
    __publicField(this, "buyoutAuction", /* @__PURE__ */ buildTransactionFunction(async (auctionId) => {
     ...
     * @twfeature EnglishAuctions
     */
    __publicField(this, "makeBid", /* @__PURE__ */ buildTransactionFunction(async (auctionId, bidAmount) => {
      const auction = await this.validateAuction(BigNumber.from(auctionId));
      ...
      if (winningBid) {
        ...
        invariant(tokenPrice.gte(minimumBidAmount));
      }
      const overrides = await this.contractWrapper.getCallOverrides() || {};
     ...
     * @twfeature EnglishAuctions
     */
    __publicField(this, "cancelAuction", /* @__PURE__ */ buildTransactionFunction(async (auctionId) => {
      const winningBid = await this.getWinningBid(auctionId);
      if (winningBid) {
     ...
     * @twfeature EnglishAuctions
     */
    __publicField(this, "closeAuctionForBidder", /* @__PURE__ */ buildTransactionFunction(async (auctionId, closeFor) => {
      if (!closeFor) {
     ...
     * @twfeature EnglishAuctions
     */
    __publicField(this, "closeAuctionForSeller", /* @__PURE__ */ buildTransactionFunction(async (auctionId) => {
      const auction = await this.validateAuction(BigNumber.from(auctionId));
      try {
        const tx = Transaction.fromContractWrapper({
          contractWrapper: this.contractWrapper,
     ...
     * @twfeature EnglishAuctions
     */
    __publicField(this, "executeSale", /* @__PURE__ */ buildTransactionFunction(async (auctionId) => {
      const auction = await this.validateAuction(BigNumber.from(auctionId));
      try {
        const winningBid = await this.getWinningBid(auctionId);
...
class MarketplaceV3Offers {
  ...
  constructor(contractWrapper, storage) {
     ...
     * @twfeature Offers
     */
    __publicField(this, "makeOffer", /* @__PURE__ */ buildTransactionFunction(async (offer) => {
     ...
     * @twfeature Offers
     */
    __publicField(this, "cancelOffer", /* @__PURE__ */ buildTransactionFunction(async (offerId) => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "cancelOffer",
        args: [offerId]
     ...
     * @twfeature Offers
     */
    __publicField(this, "acceptOffer", /* @__PURE__ */ buildTransactionFunction(async (offerId) => {
...
export {
  MarketplaceV3DirectListings as M,
  MarketplaceV3EnglishAuctions as a,
  MarketplaceV3Offers as b
};
