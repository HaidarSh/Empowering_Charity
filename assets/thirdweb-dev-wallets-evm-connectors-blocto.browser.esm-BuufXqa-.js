import { W as WagmiConnector, _ as _defineProperty, w as walletIds, a as getAddress, U as UserRejectedRequestError, n as normalizeChainId, f as ConnectorNotFoundError, b as Web3Provider, h as hexValue, S as SwitchChainError, e as getValidPublicRPCUrl } from "./index-R4o_uq0C.js";
...
const LOGIN_PERSISTING_TIME = 86400 * 1e3;
...
(function(ERROR_MESSAGE2) {
  ERROR_MESSAGE2["INVALID_TRANSACTION"] = "Invalid transaction";
  ERROR_MESSAGE2["INVALID_TRANSACTIONS"] = "Invalid transactions";
  ERROR_MESSAGE2["INVALID_TRANSACTION_VALUE"] = 'Transaction params "value" should be hex-encoded string';
...
const isValidTransaction = (transaction) => {
  if (!transaction || typeof transaction !== "object" || !("from" in transaction)) {
...
class EthereumProvider extends BloctoProvider {
  ...
  sendAsync(payload, callback) {
    return __awaiter(this, void 0, void 0, function* () {
      const separateRequests = (payload2) => {
        return payload2.reduce((acc, request) => {
          var _a;
      ...
      function processResponses(payload2, responses) {
        ...
        payload2.forEach((item) => {
          ...
          if (item.method === "eth_sendTransaction") {
            ...
            baseResponse.error = responses[0].status !== "fulfilled" ? responses[0].reason : void 0;
          } else {
            if (responseIndex < responses.length) {
              baseResponse.result = responses[responseIndex].value;
              baseResponse.error = responses[responseIndex].status !== "fulfilled" ? responses[responseIndex].reason : void 0;
              responseIndex++;
            }
          }
      ...
      const handleRequest = new Promise((resolve) => {
        if (Array.isArray(payload)) {
          ...
          const allPromise = isSendRequestsEmpty ? [...otherRequests] : [this.request(batchReqPayload), ...otherRequests];
          Promise.allSettled(allPromise).then((responses) => {
      ...
      switch (payload.method) {
        ...
        case "eth_call": {
          ...
          if (!response || response && !response.result && response.error) {
            const errorMessage = ((_d = response === null || response === void 0 ? void 0 : response.error) === null || _d === void 0 ? void 0 : _d.message) ? response.error.message : "Request failed";
  ...
  bloctoApi(url, options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      } }, options)).then((response) => responseSessionGuard(response, sessionKeyEnv, () => {
        var _a2;
        ...
        addSelfRemovableHandler("message", (event, removeListener) => {
          ...
          if (e.origin === walletServer) {
            if (e.data.type === "ETH:FRAME:RESPONSE") {
              ...
              (_a2 = this.eventListeners) === null || _a2 === void 0 ? void 0 : _a2.connect.forEach((listener) => listener({ chainId: this.chainId }));
              ...
              addSelfRemovableHandler("message", (event2, removeListener2) => {
                var _a3, _b2, _c;
                const messageEvent = event2;
                const isAccountChanged = ((_a3 = messageEvent.data) === null || _a3 === void 0 ? void 0 : _a3.type) === "BLOCTO_SDK:ACCOUNT_CHANGED";
                const isAnotherChain = ((_b2 = messageEvent.data) === null || _b2 === void 0 ? void 0 : _b2.originChain) !== CHAIN.ETHEREUM;
                if (isAccountChanged) {
  ...
  handleSwitchChain(targetChainId) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (switchableNetwork[newChainId].wallet_web_url !== switchableNetwork[oldChainId].wallet_web_url) {
        return this.enable().then(([newAccount]) => {
          var _a2;
        ...
        addSelfRemovableHandler("message", (event, removeListener) => {
          ...
          if (e.origin === walletServer) {
            if (e.data.type === "ETH:FRAME:RESPONSE") {
              ...
              if (((_a2 = e.data) === null || _a2 === void 0 ? void 0 : _a2.addr) && oldAccount) {
                setAccountStorage(sessionKeyEnv, {
                  code: (_b2 = e.data) === null || _b2 === void 0 ? void 0 : _b2.code,
                  evm: {
...
_EthereumProvider_instances = /* @__PURE__ */ new WeakSet(), _EthereumProvider_getBloctoProperties = function _EthereumProvider_getBloctoProperties2() {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (this._blocto.sessionKeyEnv && this._blocto.walletServer && this._blocto.blockchainName && this._blocto.networkType && this._blocto.switchableNetwork) {
      return this._blocto;
    }
    const supportNetworkList = yield getEvmSupport().catch((e) => {
      throw dist.ethErrors.provider.custom({
    ...
    const walletServer = this.injectedWalletServer || ETH_ENV_WALLET_SERVER_MAPPING[blocto_service_environment];
  ...
  var _a;
  if (((_a = this.existedSDK) === null || _a === void 0 ? void 0 : _a.isBlocto) && parseChainId(this.existedSDK.chainId) !== parseChainId(this.chainId)) {
    throw dist.ethErrors.provider.chainDisconnected();
  }
}, _EthereumProvider_createAuthzFrame = function _EthereumProvider_createAuthzFrame2(params, revert = true) {
  return __awaiter(this, void 0, void 0, function* () {
          ...
          if (e.origin === this.server) {
            if (e.data.type === "APTOS:FRAME:RESPONSE") {
              ...
              addSelfRemovableHandler("message", (event2, removeListener2) => {
                var _a2, _b2;
                const messageEvent = event2;
                if (((_a2 = messageEvent.data) === null || _a2 === void 0 ? void 0 : _a2.type) === "BLOCTO_SDK:ACCOUNT_CHANGED" && ((_b2 = messageEvent.data) === null || _b2 === void 0 ? void 0 : _b2.originChain) !== CHAIN.APTOS) {
                  this.disconnect();
                  removeListener2();
                }
              });
...
class BloctoConnector extends WagmiConnector {
  ...
  getProvider() {
    ...
    if (!this._provider) {
      const _chainId = chainId ?? ((_a = this.chains[0]) == null ? void 0 : _a.chainId) ?? 1;
      const _rpc = (_b = this.chains.find((x) => x.chainId === _chainId)) == null ? void 0 : _b.rpc[0];
      this._provider = (_c = new BloctoSDK({
        ethereum: {
          chainId: _chainId,
          rpc: _rpc
        },
  ...
  async isAuthorized() {
    var _a, _b;
    return !!((_b = (_a = this._provider) == null ? void 0 : _a._blocto) == null ? void 0 : _b.sessionKeyEnv);
  }
