import { c$ as ChainId, y as invariant } from "./index-R4o_uq0C.js";
...
function parseChainIdToPaperChain(chainId) {
  invariant(chainId in PAPER_CHAIN_ID_MAP);
...
async function createCheckoutLinkIntent(contractId, params) {
  ...
  const json = await res.json();
  invariant(json.checkoutLinkIntentUrl);
