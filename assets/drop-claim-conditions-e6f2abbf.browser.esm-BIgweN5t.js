...
import { X as resolveAddress, bg as parseUnits, $ as AmountSchema, b4 as includesErrorMessage, b5 as stripZeros, B as BigNumber, b2 as MaxUint256, b6 as isNode, b7 as isNativeToken, c as __vitePreload, a1 as ContractWrapper, o as buildTransactionFunction, aR as AddressZero, b8 as hexZeroPad, a2 as ContractEncoder, T as Transaction, t as toUtf8Bytes } from "./index-R4o_uq0C.js";
import { t as transformResultToClaimCondition, l as legacyContractModelToAbstract, n as newContractModelToAbstract, C as ClaimEligibility, c as convertQuantityToBigNumber, f as fetchSnapshotEntryForAddress, p as processClaimConditionInputs, d as deepEqual, e as abstractContractModelToLegacy, g as abstractContractModelToNew, u as updateExistingClaimConditions, h as prepareClaim, i as SnapshotFormatVersion } from "./index-MMLm2ukI.js";
import { h as hasFunction, d as detectContractFeature } from "./contract-appuri-5c40af52.browser.esm-FEDBCqrq.js";
class DropClaimConditions {
  constructor(contractWrapper, metadata, storage) {
     ...
     */
    __publicField(this, "update", /* @__PURE__ */ buildTransactionFunction(async (index, claimConditionInput) => {
  ...
  async getActive(options) {
    ...
    return await transformResultToClaimCondition(cc, tokenDecimals, this.contractWrapper.getProvider(), metadata.merkle || {}, this.storage, (options == null ? void 0 : options.withAllowList) || false);
  }
