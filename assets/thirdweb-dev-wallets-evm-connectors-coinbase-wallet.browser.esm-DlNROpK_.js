const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DoHYhlAm.js","assets/index-R4o_uq0C.js","assets/index-CMa6kN8T.css","assets/index-CM_H5tzn.js","assets/index-fTeTERYp.js","assets/satisfies-DoUNRw23.js"])))=>i.map(i=>d[i]);
import { W as WagmiConnector, _ as _defineProperty, w as walletIds, a as getAddress, n as normalizeChainId, b as Web3Provider, U as UserRejectedRequestError, c as __vitePreload, h as hexValue, d as ChainNotConfiguredError, e as getValidPublicRPCUrl, A as AddChainError, S as SwitchChainError } from "./index-R4o_uq0C.js";
class CoinbaseWalletConnector extends WagmiConnector {
  ...
  async getProvider() {
    var _a;
    if (!this._provider) {
      let CoinbaseWalletSDK = (await __vitePreload(async () => {
        const { default: __vite_default__ } = await import("./index-DoHYhlAm.js").then((n) => n.i);
        return { default: __vite_default__ };
      }, true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0)).default;
      ...
      const walletExtensionChainId = (_a = this._client.walletExtension) == null ? void 0 : _a.getChainId();
