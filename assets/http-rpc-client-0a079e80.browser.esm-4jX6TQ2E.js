import { cC as isTwUrl, cD as setAnalyticsHeaders, cE as StaticJsonRpcProvider, cw as isZkSyncChain, B as BigNumber, cF as MANAGED_ACCOUNT_GAS_BUFFER, cG as resolveProperties, h as hexValue, bI as keccak256, aK as defaultAbiCoder, cH as concat } from "./index-R4o_uq0C.js";
...
class HttpRpcClient {
  constructor(bundlerUrl, entryPointAddress, chainId, clientId, secretKey) {
    ...
    this.userOpJsonRpcProvider = new StaticJsonRpcProvider({
      url: this.bundlerUrl,
      headers
    }, {
