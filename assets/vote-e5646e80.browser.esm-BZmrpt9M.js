...
import { a1 as ContractWrapper, v as AbiSchema, dl as VoteContractSchema, a2 as ContractEncoder, B as BigNumber, X as resolveAddress, z as id, aF as formatUnits, c as __vitePreload, ai as Contract, bf as fetchCurrencyValue, b9 as fetchCurrencyMetadata, o as buildTransactionFunction, T as Transaction } from "./index-R4o_uq0C.js";
...
class Vote {
  constructor(network, address, storage) {
     ...
     */
    __publicField(this, "propose", /* @__PURE__ */ buildTransactionFunction(async (description, executions) => {
      if (!executions) {
        executions = [{
     ...
     */
    __publicField(this, "vote", /* @__PURE__ */ buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this = this;
     ...
     */
    __publicField(this, "execute", /* @__PURE__ */ buildTransactionFunction(async (proposalId) => {
