...
import { aB as isExtensionEnabled, aC as FEATURE_METADATA, r as fetchContractMetadataFromAddress, o as buildTransactionFunction, T as Transaction, aA as ExtensionNotImplementedError, aD as EventType, aE as estimateTransactionCost, aF as formatUnits, ad as FEATURE_APPURI, aG as replaceGatewayUrlWithScheme, aH as formatEther } from "./index-R4o_uq0C.js";
...
class ContractMetadata {
  constructor(contractWrapper, schema, storage) {
     ...
     * @twfeature ContractMetadata
     * */
    __publicField(this, "update", /* @__PURE__ */ buildTransactionFunction(async (metadata) => {
...
class ContractAppURI {
  constructor(contractWrapper, metadata, storage) {
     ...
     * @twfeature AppURI
     */
    __publicField(this, "set", /* @__PURE__ */ buildTransactionFunction(async (appURI) => {
...
export {
  ContractEvents as C,
  GasCostEstimator as G,
  ContractMetadata as a,
  ContractAppURI as b,
  detectContractFeature as d,
  hasFunction as h
};
