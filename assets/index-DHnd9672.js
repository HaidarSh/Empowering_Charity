const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DI4JdLj8.js","assets/index-R4o_uq0C.js","assets/index-CMa6kN8T.css"])))=>i.map(i=>d[i]);
import { c as __vitePreload } from "./index-R4o_uq0C.js";
const t = Symbol();
...
var define_import_meta_env_default = { BASE_URL: "/Empowering_Charity/", DEV: false, MODE: "production", PROD: true, SSR: false };
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-DI4JdLj8.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
