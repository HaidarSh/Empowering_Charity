...
import { ac as FEATURE_EDITION, B as BigNumber, aR as AddressZero, aA as ExtensionNotImplementedError, aS as FEATURE_EDITION_SUPPLY, X as resolveAddress, o as buildTransactionFunction, T as Transaction, a2 as ContractEncoder, aT as FEATURE_EDITION_ENUMERABLE, aU as FEATURE_EDITION_MINTABLE, aV as FEATURE_EDITION_BATCH_MINTABLE, aW as FEATURE_EDITION_BURNABLE, aX as FEATURE_EDITION_LAZY_MINTABLE_V2, aY as FEATURE_EDITION_UPDATABLE_METADATA, aZ as FEATURE_EDITION_CLAIM_CUSTOM, a_ as FEATURE_EDITION_CLAIM_CONDITIONS_V2, a$ as FEATURE_EDITION_SIGNATURE_MINTABLE, b0 as FEATURE_EDITION_REVEALABLE, b1 as NotFoundError, Z as z, a3 as CustomContractSchema, b2 as MaxUint256, y as invariant, b3 as getPrebuiltInfo, aM as normalizePriceValue, t as toUtf8Bytes, b4 as includesErrorMessage, b5 as stripZeros, b6 as isNode, b7 as isNativeToken, c as __vitePreload, a1 as ContractWrapper, b8 as hexZeroPad, a0 as AddressOrEnsSchema, $ as AmountSchema } from "./index-R4o_uq0C.js";
import { a as assertEnabled } from "./assertEnabled-d1700f0b.browser.esm-DFK6vCrZ.js";
import { d as detectContractFeature, h as hasFunction, a as ContractMetadata } from "./contract-appuri-5c40af52.browser.esm-FEDBCqrq.js";
import { F as FALLBACK_METADATA, a as fetchTokenMetadata, u as uploadOrExtractURIs, D as DEFAULT_QUERY_ALL_COUNT, b as uploadOrExtractURI } from "./QueryParams-32a56510.browser.esm-BJnH1Vvy.js";
import { c as calculateClaimCost, D as DelayedReveal } from "./contract-owner-49e75547.browser.esm-BiOEH91Q.js";
import { S as Signature1155PayloadInputWithTokenId, b as Signature1155PayloadOutput, M as MintRequest1155, t as transformResultToClaimCondition, l as legacyContractModelToAbstract, n as newContractModelToAbstract, C as ClaimEligibility, c as convertQuantityToBigNumber, f as fetchSnapshotEntryForAddress, p as processClaimConditionInputs, d as deepEqual, e as abstractContractModelToLegacy, g as abstractContractModelToNew, u as updateExistingClaimConditions, h as prepareClaim, i as SnapshotFormatVersion } from "./index-MMLm2ukI.js";
import { s as setErc20Allowance } from "./setErc20Allowance-7f76f677.browser.esm-LDt0ehVI.js";
class DropErc1155ClaimConditions {
  constructor(contractWrapper, metadata, storage) {
     ...
     */
    __publicField(this, "set", /* @__PURE__ */ buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this = this;
     ...
     * @param resetClaimEligibilityForAll - Whether to reset the state of who already claimed NFTs previously
     */
    __publicField(this, "setBatch", /* @__PURE__ */ buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this2 = this;
     ...
     */
    __publicField(this, "update", /* @__PURE__ */ buildTransactionFunction(async (tokenId, index, claimConditionInput) => {
  ...
  async getClaimIneligibilityReasons(tokenId, quantity, addressToCheck) {
    ...
    if (claimCondition.price.gt(0) && isNode()) {
      ...
      if (isNativeToken(claimCondition.currencyAddress)) {
        ...
        const IERC20ABI = (await __vitePreload(async () => {
...
class ERC1155Claimable {
  constructor(contractWrapper) {
     ...
     */
    __publicField(this, "to", /* @__PURE__ */ buildTransactionFunction(async (destinationAddress, tokenId, quantity, options) => {
...
class Erc1155SignatureMintable {
  constructor(contractWrapper, storage, roles) {
     ...
     */
    __publicField(this, "mint", /* @__PURE__ */ buildTransactionFunction(async (signedPayload) => {
     ...
     * @twfeature ERC1155SignatureMintable
     */
    __publicField(this, "mintBatch", /* @__PURE__ */ buildTransactionFunction(async (signedPayloads) => {
  ...
  async generateBatchFromTokenIds(payloadsToSign) {
    ...
    invariant(signer);
    await ((_a = this.roles) == null ? void 0 : _a.verify(["minter"], await signer.getAddress()));
...
class Erc1155Burnable {
  constructor(contractWrapper) {
     ...
     * ```
     */
    __publicField(this, "tokens", /* @__PURE__ */ buildTransactionFunction(async (tokenId, amount) => {
     ...
     * ```
     */
    __publicField(this, "from", /* @__PURE__ */ buildTransactionFunction(async (account, tokenId, amount) => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "burn",
     ...
     * ```
     */
    __publicField(this, "batch", /* @__PURE__ */ buildTransactionFunction(async (tokenIds, amounts) => {
      const account = await this.contractWrapper.getSignerAddress();
     ...
     * ```
     */
    __publicField(this, "batchFrom", /* @__PURE__ */ buildTransactionFunction(async (account, tokenIds, amounts) => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "burnBatch",
...
class Erc1155Enumerable {
  ...
  async owned(walletAddress, queryParams) {
    ...
    if (queryParams) {
      const start = (queryParams == null ? void 0 : queryParams.start) || 0;
      const count = (queryParams == null ? void 0 : queryParams.count) || DEFAULT_QUERY_ALL_COUNT;
...
class Erc1155LazyMintable {
  ...
  constructor(erc1155, contractWrapper, storage) {
     ...
     */
    __publicField(this, "lazyMint", /* @__PURE__ */ buildTransactionFunction(async (metadatas, options) => {
    ...
    __publicField(this, "updateMetadata", /* @__PURE__ */ buildTransactionFunction(async (tokenId, metadata, options) => {
...
class Erc1155BatchMintable {
  constructor(erc1155, contractWrapper, storage) {
     ...
     * ```
     */
    __publicField(this, "to", /* @__PURE__ */ buildTransactionFunction(async (to, metadataWithSupply) => {
...
class Erc1155Mintable {
  ...
  constructor(erc1155, contractWrapper, storage) {
     ...
     * ```
     */
    __publicField(this, "additionalSupplyTo", /* @__PURE__ */ buildTransactionFunction(async (to, tokenId, additionalSupply) => {
...
class Erc1155 {
  constructor(contractWrapper, storage, chainId) {
     ...
     * @twfeature ERC1155
     */
    __publicField(this, "transfer", /* @__PURE__ */ buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this = this;
     ...
     */
    __publicField(this, "transferBatch", /* @__PURE__ */ buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this2 = this;
     ...
     * @twfeature ERC1155
     */
    __publicField(this, "transferFrom", /* @__PURE__ */ buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this3 = this;
     ...
     * @twfeature ERC1155
     */
    __publicField(this, "setApprovalForAll", /* @__PURE__ */ buildTransactionFunction(async (operator, approved) => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
     ...
     * @twfeature ERC1155BatchTransferable
     */
    __publicField(this, "airdrop", /* @__PURE__ */ buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this4 = this;
     ...
     * @twfeature ERC1155Mintable
     */
    __publicField(this, "mintTo", /* @__PURE__ */ buildTransactionFunction(async (receiver, metadataWithSupply) => {
     ...
     * @twfeature ERC1155Mintable
     */
    __publicField(this, "mintAdditionalSupplyTo", /* @__PURE__ */ buildTransactionFunction(async (receiver, tokenId, additionalSupply) => {
     ...
     */
    __publicField(this, "mintBatch", /* @__PURE__ */ buildTransactionFunction(async (metadataWithSupply) => {
     ...
     * @twfeature ERC1155BatchMintable
     */
    __publicField(this, "mintBatchTo", /* @__PURE__ */ buildTransactionFunction(async (receiver, metadataWithSupply) => {
      var _a;
     ...
     * @twfeature ERC1155Burnable
     */
    __publicField(this, "burnFrom", /* @__PURE__ */ buildTransactionFunction(async (account, tokenId, amount) => {
     ...
     * @twfeature ERC1155Burnable
     */
    __publicField(this, "burnBatch", /* @__PURE__ */ buildTransactionFunction(async (tokenIds, amounts) => {
     ...
     * @twfeature ERC1155Burnable
     */
    __publicField(this, "burnBatchFrom", /* @__PURE__ */ buildTransactionFunction(async (account, tokenIds, amounts) => {
     ...
     */
    __publicField(this, "updateMetadata", /* @__PURE__ */ buildTransactionFunction(async (tokenId, metadata) => {
     ...
     */
    __publicField(this, "claim", /* @__PURE__ */ buildTransactionFunction(async (tokenId, quantity, options) => {
     ...
     * @twfeature ERC1155ClaimCustom | ERC1155ClaimPhasesV2 | ERC1155ClaimPhasesV1 | ERC1155ClaimConditionsV2 | ERC1155ClaimConditionsV1
     */
    __publicField(this, "claimTo", /* @__PURE__ */ buildTransactionFunction(async (destinationAddress, tokenId, quantity, options) => {
...
export {
  DropErc1155ClaimConditions as D,
  Erc1155 as E,
  Erc1155SignatureMintable as a
};
