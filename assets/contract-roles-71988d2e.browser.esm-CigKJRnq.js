...
import { a6 as FEATURE_PERMISSIONS, y as invariant, aP as getRoleHash, o as buildTransactionFunction, a2 as ContractEncoder, X as resolveAddress, T as Transaction, aQ as MissingRoleError } from "./index-R4o_uq0C.js";
...
class ContractRoles {
  ...
  constructor(contractWrapper, roles) {
     ...
     *
     * */
    __publicField(this, "setAll", /* @__PURE__ */ buildTransactionFunction(async (rolesWithAddresses, actingAddress) => {
      var _a, _b;
      ...
      invariant(roles.length);
      invariant(roles.every((role) => this.roles.includes(role)));
     ...
     * @twfeature Permissions
     */
    __publicField(this, "grant", /* @__PURE__ */ buildTransactionFunction(async (role, address) => {
      invariant(this.roles.includes(role));
     ...
     * @twfeature Permissions
     */
    __publicField(this, "revoke", /* @__PURE__ */ buildTransactionFunction(async (role, address) => {
      invariant(this.roles.includes(role));
      const resolvedAddress = await resolveAddress(address);
