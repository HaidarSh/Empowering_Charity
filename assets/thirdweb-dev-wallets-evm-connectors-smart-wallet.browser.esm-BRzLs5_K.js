...
import { C as Connector, g as getChainProvider, cx as ENTRYPOINT_ADDRESS, cI as DEFAULT_FACTORY_ADDRESS, a as getAddress, cG as resolveProperties, aR as AddressZero, B as BigNumber, cJ as ThirdwebSDK, cK as ACCOUNT_CORE_ABI, t as toUtf8Bytes, cL as getGasPrice, aH as formatEther, cM as dist, cN as LOCAL_NODE_PKEY, cA as hexConcat, bS as arrayify, c as __vitePreload, cO as Wallet, ai as Contract, cC as isTwUrl, cD as setAnalyticsHeaders, cP as BaseProvider, h as hexValue, _ as _defineProperty, cQ as getDynamicFeeData, cR as c42220, cS as c44787, cT as c62320, aK as defaultAbiCoder, av as Signer, aw as defineReadOnly, co as hashMessage, cU as chainIdToThirdwebRpc, cE as StaticJsonRpcProvider, cV as signTypedDataInternal, cW as checkContractWalletSignature } from "./index-R4o_uq0C.js";
import { H as HttpRpcClient, h as hexlifyUserOp, g as getUserOpHashV06, r as randomNonce } from "./http-rpc-client-0a079e80.browser.esm-4jX6TQ2E.js";
class PaymasterAPI {
}
  ...
  async signMessage(message) {
    ...
    if (factorySupports712) {
      const result = await signTypedDataInternal(this, {
        ...
        message: defaultAbiCoder.encode(["bytes32"], [originalMsgHash])
      });
...
class AccountAPI extends BaseAccountAPI {
  ...
  async createApproveTx() {
    ...
    const ethersSigner = new Wallet(LOCAL_NODE_PKEY, this.provider);
...
class SmartWalletConnector extends Connector {
  ...
  async hasPermissionToExecute(transaction) {
    ...
    const restrictions = (_a = (await accountContract.account.getAllSigners()).filter((item) => getAddress(item.signer) === getAddress(signerAddress))[0]) == null ? void 0 : _a.permissions;
    if (!restrictions) {
      return false;
    }
