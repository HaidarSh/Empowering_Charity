import { n as ne$1, s as se$1, T as T$2, t as te$1, a as a$2, o as oe$1, R as R$1, p as p$1, y as y$1 } from "./index-DHnd9672.js";
import { eb as browser } from "./index-R4o_uq0C.js";
/**
 * @license
...
function n$5(n2) {
  return (t2, o3) => void 0 !== o3 ? e$4(n2, t2, o3) : i$3(n2, t2);
}
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$2 = window, e$3 = t$2.ShadowRoot && (void 0 === t$2.ShadyCSS || t$2.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, s$3 = Symbol(), n$3 = /* @__PURE__ */ new WeakMap();
let o$4 = class o {
 ...
 */
var s$2;
const e$2 = window, r$1 = e$2.trustedTypes, h$2 = r$1 ? r$1.emptyScript : "", o$3 = e$2.reactiveElementPolyfillSupport, n$2 = { toAttribute(t2, i2) {
  switch (i2) {
    case Boolean:
      t2 = t2 ? h$2 : null;
      break;
  ...
  return s2;
} }, a$1 = (t2, i2) => i2 !== t2 && (i2 == i2 || t2 == t2), l$3 = { attribute: true, type: String, converter: n$2, reflect: false, hasChanged: a$1 }, d$1 = "finalized";
...
u$1[d$1] = true, u$1.elementProperties = /* @__PURE__ */ new Map(), u$1.elementStyles = [], u$1.shadowRootOptions = { mode: "open" }, null == o$3 || o$3({ ReactiveElement: u$1 }), (null !== (s$2 = e$2.reactiveElementVersions) && void 0 !== s$2 ? s$2 : e$2.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var t$1;
const i$1 = window, s$1 = i$1.trustedTypes, e$1 = s$1 ? s$1.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, o$2 = "$lit$", n$1 = `lit$${(Math.random() + "").slice(9)}$`, l$2 = "?" + n$1, h$1 = `<${l$2}>`, r = document, u2 = () => r.createComment(""), d = (t2) => null === t2 || "object" != typeof t2 && "function" != typeof t2, c$1 = Array.isArray, v$1 = (t2) => c$1(t2) || "function" == typeof (null == t2 ? void 0 : t2[Symbol.iterator]), a = "[ 	\n\f\r]", f = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, _$1 = /-->/g, m = />/g, p = RegExp(`>|${a}(?:([^\\s"'>=/]+)(${a}*=${a}*(?:[^ 	
...
const V = (t2, i2) => {
  ...
  for (let i3 = 0; i3 < s2; i3++) {
    ...
    r2 += u3 === f ? s3 + h$1 : v2 >= 0 ? (e2.push(d2), s3.slice(0, v2) + o$2 + s3.slice(v2) + n$1 + w2) : s3 + n$1 + (-2 === v2 ? (e2.push(void 0), i3) : w2);
  }
  ...
  constructor({ strings: t2, _$litType$: i2 }, e2) {
    ...
    for (; null !== (h2 = C.nextNode()) && v2.length < c2; ) {
      if (1 === h2.nodeType) {
        if (h2.hasAttributes()) {
          const t3 = [];
          for (const i3 of h2.getAttributeNames()) if (i3.endsWith(o$2) || i3.startsWith(n$1)) {
            const s2 = f2[d2++];
        ...
        let t3 = -1;
        for (; -1 !== (t3 = h2.data.indexOf(n$1, t3 + 1)); ) v2.push({ type: 7, index: r2 }), t3 += n$1.length - 1;
      }
      r2++;
    }
  }
...
null == B$1 || B$1(N, R), (null !== (t$1 = i$1.litHtmlVersions) && void 0 !== t$1 ? t$1 : i$1.litHtmlVersions = []).push("2.8.0");
const D$1 = (t2, i2, s2) => {
  var e2, o3;
...
}, globalCss: i$2`*,::after,::before{margin:0;padding:0;box-sizing:border-box;font-style:normal;text-rendering:optimizeSpeed;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-tap-highlight-color:transparent;backface-visibility:hidden}button{cursor:pointer;display:flex;justify-content:center;align-items:center;position:relative;border:none;background-color:transparent;transition:all .2s ease}@media (hover:hover) and (pointer:fine){button:active{transition:all .1s ease;transform:scale(.93)}}button::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;transition:background-color,.2s ease}button:disabled{cursor:not-allowed}button svg,button wcm-text{position:relative;z-index:1}input{border:none;outline:0;appearance:none}img{display:block}::selection{color:var(--wcm-accent-fill-color);background:var(--wcm-accent-color)}` }, at = i$2`button{border-radius:var(--wcm-secondary-button-border-radius);height:28px;padding:0 10px;background-color:var(--wcm-accent-color)}button path{fill:var(--wcm-accent-fill-color)}button::after{border-radius:inherit;border:1px solid var(--wcm-color-overlay)}button:disabled::after{background-color:transparent}.wcm-icon-left svg{margin-right:5px}.wcm-icon-right svg{margin-left:5px}button:active::after{background-color:var(--wcm-color-overlay)}.wcm-ghost,.wcm-ghost:active::after,.wcm-outline{background-color:transparent}.wcm-ghost:active{opacity:.5}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}.wcm-ghost:hover::after{background-color:transparent}.wcm-ghost:hover{opacity:.5}}button:disabled{background-color:var(--wcm-color-bg-3);pointer-events:none}.wcm-ghost::after{border-color:transparent}.wcm-ghost path{fill:var(--wcm-color-fg-2)}.wcm-outline path{fill:var(--wcm-accent-color)}.wcm-outline:disabled{background-color:transparent;opacity:.5}`;
...
T.styles = [h.globalCss, at], F([n$5({ type: Boolean })], T.prototype, "disabled", 2), F([n$5()], T.prototype, "iconLeft", 2), F([n$5()], T.prototype, "iconRight", 2), F([n$5()], T.prototype, "onClick", 2), F([n$5()], T.prototype, "variant", 2), T = F([e$5("wcm-button")], T);
...
ee.styles = [h.globalCss, nt], ue([n$5({ type: Boolean })], ee.prototype, "disabled", 2), ue([n$5()], ee.prototype, "variant", 2), ee = ue([e$5("wcm-button-big")], ee);
const dt = i$2`:host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
var wt = (e2, o3, r2, a2) => {
...
fe.styles = [h.globalCss, pt], fe = ut([e$5("wcm-modal-backcard")], fe);
const bt = i$2`main{padding:20px;padding-top:0;width:100%}`;
var yt = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
...
xe.styles = [h.globalCss, bt], xe = yt([e$5("wcm-modal-content")], xe);
const $t = i$2`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
var Ot = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
...
ye.styles = [h.globalCss, $t], ye = Ot([e$5("wcm-modal-footer")], ye);
const Wt = i$2`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
...
S.styles = [h.globalCss, Wt], te([n$5()], S.prototype, "title", 2), te([n$5()], S.prototype, "onAction", 2), te([n$5()], S.prototype, "actionIcon", 2), te([n$5({ type: Boolean })], S.prototype, "border", 2), S = te([e$5("wcm-modal-header")], S);
...
} }, Mt = i$2`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
...
oe.styles = [h.globalCss, Mt], $e([t$3()], oe.prototype, "view", 2), $e([t$3()], oe.prototype, "prevView", 2), oe = $e([e$5("wcm-modal-router")], oe);
const At = i$2`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
...
ne.styles = [h.globalCss, At], ze([t$3()], ne.prototype, "open", 2), ne = ze([e$5("wcm-modal-toast")], ne);
...
j.styles = [h.globalCss, Nt], q([n$5()], j.prototype, "uri", 2), q([n$5({ type: Number })], j.prototype, "size", 2), q([n$5()], j.prototype, "imageId", 2), q([n$5()], j.prototype, "walletId", 2), q([n$5()], j.prototype, "imageUrl", 2), j = q([e$5("wcm-qrcode")], j);
...
ce.styles = [h.globalCss, Bt], Fe([n$5()], ce.prototype, "onChange", 2), ce = Fe([e$5("wcm-search-input")], ce);
const zt = i$2`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
var qt = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
...
re.styles = [h.globalCss, Qt], Oe([n$5()], re.prototype, "variant", 2), Oe([n$5()], re.prototype, "color", 2), re = Oe([e$5("wcm-text")], re);
const Gt = i$2`button{width:100%;height:100%;border-radius:var(--wcm-button-hover-highlight-border-radius);display:flex;align-items:flex-start}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}button>div{width:80px;padding:5px 0;display:flex;flex-direction:column;align-items:center}wcm-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center}wcm-wallet-image{height:60px;width:60px;transition:all .2s ease;border-radius:var(--wcm-wallet-icon-border-radius);margin-bottom:5px}.wcm-sublabel{margin-top:2px}`;
...
L2.styles = [h.globalCss, Gt], _([n$5()], L2.prototype, "onClick", 2), _([n$5()], L2.prototype, "name", 2), _([n$5()], L2.prototype, "walletId", 2), _([n$5()], L2.prototype, "label", 2), _([n$5()], L2.prototype, "imageId", 2), _([n$5({ type: Boolean })], L2.prototype, "installed", 2), _([n$5({ type: Boolean })], L2.prototype, "recent", 2), L2 = _([e$5("wcm-wallet-button")], L2);
...
Q.styles = [h.globalCss, eo], se([n$5()], Q.prototype, "walletId", 2), se([n$5()], Q.prototype, "imageId", 2), se([n$5()], Q.prototype, "imageUrl", 2), Q = se([e$5("wcm-wallet-image")], Q);
...
qe([t$3()], We.prototype, "preload", 2), We = qe([e$5("wcm-explorer-context")], We);
var no = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
...
Ie.styles = [h.globalCss, co], Ie = ho([e$5("wcm-android-wallet-selection")], Ie);
const wo = i$2`@keyframes loading{to{stroke-dashoffset:0}}@keyframes shake{10%,90%{transform:translate3d(-1px,0,0)}20%,80%{transform:translate3d(1px,0,0)}30%,50%,70%{transform:translate3d(-2px,0,0)}40%,60%{transform:translate3d(2px,0,0)}}:host{display:flex;flex-direction:column;align-items:center}div{position:relative;width:110px;height:110px;display:flex;justify-content:center;align-items:center;margin:40px 0 20px 0;transform:translate3d(0,0,0)}svg{position:absolute;width:110px;height:110px;fill:none;stroke:transparent;stroke-linecap:round;stroke-width:2px;top:0;left:0}use{stroke:var(--wcm-accent-color);animation:loading 1s linear infinite}wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:90px;height:90px}wcm-text{margin-bottom:40px}.wcm-error svg{stroke:var(--wcm-error-color)}.wcm-error use{display:none}.wcm-error{animation:shake .4s cubic-bezier(.36,.07,.19,.97) both}.wcm-stale svg,.wcm-stale use{display:none}`;
...
D.styles = [h.globalCss, wo], K([n$5()], D.prototype, "walletId", 2), K([n$5()], D.prototype, "imageId", 2), K([n$5({ type: Boolean })], D.prototype, "isError", 2), K([n$5({ type: Boolean })], D.prototype, "isStale", 2), K([n$5()], D.prototype, "label", 2), D = K([e$5("wcm-connector-waiting")], D);
...
Ee.styles = [h.globalCss, vo], Ee = fo([e$5("wcm-desktop-wallet-selection")], Ee);
const xo = i$2`div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
var Co = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
...
Me.styles = [h.globalCss, xo], Me = Co([e$5("wcm-legal-notice")], Me);
const ko = i$2`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
var Io = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
...
Le.styles = [h.globalCss, ko], Le = Io([e$5("wcm-mobile-wallet-selection")], Le);
...
ae.styles = [h.globalCss, Eo], Re([t$3()], ae.prototype, "open", 2), Re([t$3()], ae.prototype, "active", 2), ae = Re([e$5("wcm-modal")], ae);
const Ro = i$2`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
...
B.styles = [h.globalCss, Ro], le([n$5({ type: Boolean })], B.prototype, "isMobile", 2), le([n$5({ type: Boolean })], B.prototype, "isDesktop", 2), le([n$5({ type: Boolean })], B.prototype, "isWeb", 2), le([n$5({ type: Boolean })], B.prototype, "isRetry", 2), B = le([e$5("wcm-platform-selection")], B);
const To = i$2`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
var Do = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
...
Ae.styles = [h.globalCss, To], Ae = Do([e$5("wcm-view-all-wallets-button")], Ae);
const No = i$2`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
...
Y.styles = [h.globalCss, No], de([n$5()], Y.prototype, "walletId", 2), de([n$5()], Y.prototype, "imageId", 2), de([t$3()], Y.prototype, "uri", 2), Y = de([e$5("wcm-walletconnect-qr")], Y);
var Ho = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
...
Pe.styles = [h.globalCss], Pe = Ho([e$5("wcm-connect-wallet-view")], Pe);
const zo = i$2`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
...
me.styles = [h.globalCss, zo], Ke([t$3()], me.prototype, "isError", 2), me = Ke([e$5("wcm-desktop-connecting-view")], me);
const qo = i$2`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
var Yo = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
...
he.styles = [h.globalCss, Go], Ye([t$3()], he.prototype, "isError", 2), he = Ye([e$5("wcm-mobile-connecting-view")], he);
const er = i$2`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var rr = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
...
je.styles = [h.globalCss, er], je = rr([e$5("wcm-mobile-qr-connecting-view")], je);
var ir = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
...
_e.styles = [h.globalCss], _e = ir([e$5("wcm-qrcode-view")], _e);
const nr = i$2`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
...
U.styles = [h.globalCss, nr], ie([t$3()], U.prototype, "loading", 2), ie([t$3()], U.prototype, "firstFetch", 2), ie([t$3()], U.prototype, "search", 2), ie([t$3()], U.prototype, "endReached", 2), U = ie([e$5("wcm-wallet-explorer-view")], U);
const dr = i$2`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
...
we.styles = [h.globalCss, dr], Ge([t$3()], we.prototype, "isError", 2), we = Ge([e$5("wcm-web-connecting-view")], we);
export {
  ae as WcmModal,
  j as WcmQrCode
};
