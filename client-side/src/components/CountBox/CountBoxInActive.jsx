...
export default function CountBoxActiveInActive({ title, value }) {
  return (
    <div className="flex flex-col items-center w-[150px]">
      <h4 className="box font-epilogue font-bold text-[30px] text-[var(--custombuttom-text-color)] p-3 bg-[#e74c3c] rounded-t-[10px] w-full text-center truncate cursor-pointer">
        {value}
      </h4>
